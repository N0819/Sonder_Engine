...
from spatial_barriers import normalize_barrier
from spatial_containment import _NEVER_STATIONED_KINDS
from spatial_contacts import _clean_contact, _contact_key
from spatial_identity import _ci_get, _entity_named, room_of, same_subject
