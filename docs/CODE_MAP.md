...
| `agents/common.py` | 5432 | Shared normalization, lore, delivery, and perception helpers. | `attire`, `character_schema`, `crowds`, `db`, `llm_quality`, `memory`, `providers`, `scene`, `schemas`, `spatial`, `theory_of_mind` |
| `agents/director.py` | 5077 | Scene establishment, player interpretation, and objective resolution. | `agents.common`, `attire`, `character_schema`, `db`, `memory`, `paradox`, `prompts`, `providers`, `scene`, `schemas`, `spatial` |
...
| `agents/perception.py` | 3976 | Opening, action-onset, and outcome observer views. | `affect`, `agents.common`, `character_schema`, `db`, `prompts`, `scene`, `spatial` |
...
| `prompts.py` | 4225 | Default system prompts and prompt preset access. | `db` |
...
| `_scrub_invented_dialogue()` | 4309 | 145 lines |
| `_check_narrator_fidelity()` | 5246 | 123 lines |
| `_extract_authority_claims()` | 1174 | 106 lines |
| `_perceptible_entities()` | 752 | 98 lines |
| `_check_presence_knowledge_channel()` | 3119 | 95 lines |
| `region_visibility()` | 503 | 92 lines |
| `_check_quote_attribution()` | 4979 | 91 lines |

### `agents/director.py`

| Function | Start | Size |
|---|---:|---:|
| `director_resolve()` | 3769 | 1185 lines |
| `director_interpret()` | 749 | 388 lines |
| `_reconcile_resolution()` | 3252 | 315 lines |
| `_reconcile_near_group_positions()` | 2243 | 201 lines |
| `_evidence_present()` | 2925 | 179 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `perception_outcome()` | 3174 | 803 lines |
| `perception_act()` | 2466 | 519 lines |
| `_observer_scene_payload()` | 847 | 204 lines |
| `perception_establish()` | 2288 | 177 lines |
| `_previous_open_group_continuity()` | 155 | 117 lines |
| `_strip_self_narration()` | 1685 | 107 lines |
| `_inject_onset_speech()` | 1209 | 96 lines |
| `_source_channels()` | 1490 | 86 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `get_prompt()` | 4216 | 10 lines |
| `presets()` | 4207 | 2 lines |
| `active_preset()` | 4210 | 2 lines |
| `nsfw_enabled()` | 4213 | 2 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `merge_scene_with_diff()` | 6030 | 296 lines |
| `apply_contact_ops()` | 3501 | 254 lines |
| `sprint_reach()` | 4691 | 175 lines |
| `apply_transit_dock_edges()` | 5404 | 165 lines |
| `contacts_from_entity_state()` | 2816 | 137 lines |
| `hear_level()` | 988 | 120 lines |
| `visible_adjacent_rooms()` | 4936 | 117 lines |
| `contact_sensation()` | 4285 | 115 lines |
