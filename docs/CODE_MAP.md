...
| `schemas.py` | 2463 | Pydantic output contracts and semantic validation for agent payloads. | — |
...
| `semantic_output_errors()` | 2299 | 111 lines |
| `validate_llm_output_strict()` | 2411 | 53 lines |
