...
| `agents/director.py` | 4386 | Scene establishment, player interpretation, and objective resolution. | `agents.common`, `attire`, `character_schema`, `db`, `memory`, `paradox`, `prompts`, `providers`, `scene`, `schemas`, `spatial` |
...
| `prompts.py` | 3872 | Default system prompts and prompt preset access. | `db` |
...
| `schemas.py` | 3809 | Pydantic output contracts and semantic validation for agent payloads. | — |
...
| Function | Start | Size |
|---|---:|---:|
| `director_resolve()` | 3282 | 1105 lines |
| `director_interpret()` | 324 | 378 lines |
| `_reconcile_resolution()` | 2765 | 315 lines |
| `_reconcile_near_group_positions()` | 1806 | 201 lines |
| `_evidence_present()` | 2470 | 148 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `get_prompt()` | 3863 | 10 lines |
| `presets()` | 3854 | 2 lines |
| `active_preset()` | 3857 | 2 lines |
| `nsfw_enabled()` | 3860 | 2 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `preprocess_llm_output()` | 2874 | 245 lines |
| `_lenient_coerce()` | 517 | 159 lines |
| `semantic_output_errors()` | 3533 | 113 lines |
| `validate_llm_output_strict()` | 3708 | 102 lines |
| `_coerce_conditions()` | 2646 | 50 lines |
| `_declared()` | 357 | 48 lines |
| `_coerce_station_table()` | 49 | 41 lines |
| `_coerce_evidence_refs()` | 1771 | 41 lines |
