...
| `agents/director.py` | 4335 | Scene establishment, player interpretation, and objective resolution. | `agents.common`, `attire`, `character_schema`, `db`, `memory`, `paradox`, `prompts`, `providers`, `scene`, `schemas`, `spatial` |
...
| `agents/perception.py` | 3738 | Opening, action-onset, and outcome observer views. | `affect`, `agents.common`, `character_schema`, `db`, `prompts`, `scene`, `spatial` |
...
| `prompts.py` | 3867 | Default system prompts and prompt preset access. | `db` |
...
| `schemas.py` | 3798 | Pydantic output contracts and semantic validation for agent payloads. | — |
...
| Function | Start | Size |
|---|---:|---:|
| `perception_outcome()` | 2962 | 777 lines |
| `perception_act()` | 2282 | 491 lines |
| `perception_establish()` | 2108 | 173 lines |
| `_previous_open_group_continuity()` | 152 | 117 lines |
| `_observer_scene_payload()` | 817 | 117 lines |
| `_strip_self_narration()` | 1505 | 107 lines |
| `_inject_onset_speech()` | 1029 | 96 lines |
| `_source_channels()` | 1310 | 86 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `get_prompt()` | 3858 | 10 lines |
| `presets()` | 3849 | 2 lines |
| `active_preset()` | 3852 | 2 lines |
| `nsfw_enabled()` | 3855 | 2 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `preprocess_llm_output()` | 2863 | 245 lines |
| `_lenient_coerce()` | 517 | 159 lines |
| `semantic_output_errors()` | 3522 | 113 lines |
| `validate_llm_output_strict()` | 3697 | 102 lines |
| `_coerce_conditions()` | 2635 | 50 lines |
| `_declared()` | 357 | 48 lines |
| `_coerce_station_table()` | 49 | 41 lines |
| `_coerce_evidence_refs()` | 1760 | 41 lines |
