...
| `agents/character.py` | 992 | Private character decision agent. | `affect`, `agents.common`, `character_schema`, `db`, `frames`, `memory`, `prompts`, `psychology_runtime`, `scene`, `schemas`, `spatial`, `survival`, `theory_of_mind` |
...
| `prompts.py` | 2830 | Default system prompts and prompt preset access. | `db` |
...
| Function | Start | Size |
|---|---:|---:|
| `character_step()` | 609 | 384 lines |
| `_annotate_known_exits()` | 301 | 306 lines |
| `_verdict()` | 206 | 44 lines |
| `_recent_self_lines()` | 80 | 36 lines |
| `_frontier_hops()` | 265 | 34 lines |
| `_known_pronouns()` | 118 | 33 lines |
| `_merge_standing_intentions()` | 63 | 15 lines |
| `_appeal()` | 252 | 11 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `get_prompt()` | 2821 | 10 lines |
| `presets()` | 2812 | 2 lines |
| `active_preset()` | 2815 | 2 lines |
| `nsfw_enabled()` | 2818 | 2 lines |
