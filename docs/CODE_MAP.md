...
| `schemas.py` | 4678 | Pydantic output contracts and semantic validation for agent payloads. | — |
...
| `validate_llm_output_strict()` | 4552 | 127 lines |
| `semantic_output_errors()` | 4359 | 113 lines |
