...
| `agents/composer.py` | 1839 |  | `agents.common`, `story.scene`, `world.spatial` |
...
| `agents/perception.py` | 4546 | Opening, action-onset, and outcome observer views. | `agents`, `agents.common`, `core.db`, `mind`, `story.character_schema`, `story.scene`, `world.spatial` |
...
| `persist/checkpoints.py` | 1233 |  | `core.db`, `mind.memory` |
| `persist/commit.py` | 577 |  | `core.db`, `core.frames`, `llm.prompts`, `llm.providers`, `mind`, `mind.memory`, `mind.theory_of_mind`, `persist.commit_attire`, `persist.commit_background`, `persist.commit_common`, `persist.commit_destruction`, `persist.commit_entities`, `persist.commit_ledgers`, `persist.commit_mapping`, `persist.commit_mechanics`, `persist.commit_memory`, `persist.commit_memory_write`, `persist.commit_place_graph`, `persist.commit_room_registry`, `persist.commit_scene_state`, `story`, `story.character_schema`, `story.scene`, `world.comfort`, `world.mechanics`, `world.paradox`, `world.spatial`, `world.spatial_frames`, `world.survival`, `world.weather` |
| `persist/commit_attire.py` | 940 |  | `persist.commit_common`, `story` |
| `persist/commit_background.py` | 1570 |  | `core.db`, `mind.memory`, `persist.commit_common`, `story.character_schema`, `story.scene`, `world.spatial` |
...
| `story/scene.py` | 2012 |  | `core.db`, `story`, `story.character_schema`, `world.spatial` |
| `web/__init__.py` | 6 |  | — |
| `web/app.py` | 5795 |  | `agents`, `core`, `core.db`, `core.frames`, `dressing.ambience`, `dressing.backdrops`, `llm`, `llm.prompts`, `llm.providers`, `mind.memory`, `persist.chat_archive`, `persist.checkpoints`, `persist.commit`, `story`, `story.character_schema`, `story.dialogue_colors`, `story.importers`, `story.scene`, `web`, `web.auth_routes`, `world`, `world.survival` |
...
| Function | Start | Size |
|---|---:|---:|
| `pose_percepts()` | 671 | 92 lines |
| `_render_view_english()` | 1340 | 91 lines |
| `_render_episode_english()` | 1570 | 80 lines |
| `presence_percepts()` | 550 | 77 lines |
| `observations_from_render()` | 1765 | 75 lines |
| `speech_percept()` | 882 | 61 lines |
| `_render_presence_group()` | 1090 | 59 lines |
| `_episode_sentence()` | 1510 | 58 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `_composer_outcome()` | 4204 | 343 lines |
| `perception_outcome()` | 2921 | 303 lines |
| `perception_act()` | 2479 | 254 lines |
| `_observer_scene_payload()` | 816 | 212 lines |
| `_composer_act()` | 3984 | 130 lines |
| `_previous_open_group_continuity()` | 165 | 117 lines |
| `perception_establish()` | 2367 | 111 lines |
| `_strip_self_narration()` | 1663 | 107 lines |
