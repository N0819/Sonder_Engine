...
| `agents/common.py` | 9537 | Shared normalization, lore, delivery, and perception helpers. | `core.db`, `core.pipeline_context`, `llm.llm_quality`, `llm.prompts`, `llm.providers`, `llm.schemas`, `mind.memory`, `mind.theory_of_mind`, `persist.commit`, `story`, `story.character_schema`, `story.provenance_text`, `story.scene`, `world`, `world.spatial` |
| `agents/composer.py` | 3910 |  | `agents.common`, `core.pipeline_context`, `story.provenance_text`, `story.scene`, `world.spatial` |
| `agents/director.py` | 4960 | Scene establishment, player interpretation, and objective resolution. | `agents.common`, `agents.director_contact`, `agents.director_evidence`, `agents.director_fanout`, `agents.director_floors`, `agents.director_lingua`, `agents.director_movement`, `agents.director_reconcile`, `agents.director_scopes`, `agents.director_views`, `core.db`, `llm`, `llm.prompts`, `llm.providers`, `llm.schemas`, `mind.memory`, `story`, `story.attire`, `story.character_schema`, `story.scene`, `world.paradox`, `world.spatial`, `world.survival` |
...
| `agents/director_floors.py` | 1844 |  | `agents.common`, `agents.director_lingua`, `story.character_schema`, `story.scene`, `world.mechanics`, `world.spatial` |
...
| `persist/commit_background.py` | 4245 | Background presences: tracking, identity folding, the reactor gate, promotion to cast. | `core.db`, `mind.memory`, `persist.commit_common`, `story.character_schema`, `story.scene`, `world.spatial` |
...
| `persist/commit_scene_state.py` | 1955 | The prepared post-turn scene: pre-lock build, scene commit domain, book anchoring, ground advance. | `core.db`, `core.pipeline_context`, `mind.memory`, `persist.commit_attire`, `persist.commit_common`, `persist.commit_destruction`, `persist.commit_room_registry`, `story.character_schema`, `story.provenance_text`, `world.mechanics`, `world.spatial`, `world.spatial_frames`, `world.weather` |
...
| `world/spatial_senses.py` | 1456 |  | `world.spatial_barriers`, `world.spatial_contacts`, `world.spatial_containment`, `world.spatial_geometry`, `world.spatial_identity`, `world.spatial_light`, `world.spatial_orientation`, `world.spatial_routing` |
...
| Function | Start | Size |
|---|---:|---:|
| `norm_sequence()` | 3632 | 284 lines |
| `_check_narrator_fidelity()` | 9015 | 221 lines |
| `presence_figures_for_room()` | 1885 | 211 lines |
| `_unknown_actor_label()` | 4392 | 152 lines |
| `_scrub_invented_dialogue()` | 7655 | 151 lines |
| `observer_body_regions()` | 1449 | 137 lines |
| `_scrub_unknown_identities()` | 4644 | 124 lines |
| `validated_player_state_assertions()` | 9349 | 121 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `director_resolve()` | 3009 | 1918 lines |
| `director_interpret()` | 757 | 660 lines |
| `_reconcile_resolution()` | 1793 | 522 lines |
| `_run_specialists()` | 2522 | 263 lines |
| `director_establish()` | 321 | 171 lines |
| `_reconcile_interpretation()` | 1419 | 139 lines |
| `_specialist_repairs()` | 1620 | 119 lines |
| `_ground_public_evidence()` | 2827 | 112 lines |
...
| `_travel_continues()` | 993 | 109 lines |
| `_guard_approach_is_not_arrival()` | 1104 | 96 lines |
| `_apply_following_movement()` | 584 | 88 lines |
| `_unreachable_position_writes()` | 673 | 68 lines |
| `crossing_legs()` | 1202 | 59 lines |
| `declared_walk_leg()` | 826 | 50 lines |
| `_travel_in_flight_view()` | 942 | 49 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `preprocess_llm_output()` | 4379 | 327 lines |
| `_lenient_coerce()` | 769 | 159 lines |
| `validate_llm_output_strict()` | 5516 | 130 lines |
| `semantic_output_errors()` | 5313 | 108 lines |
| `canonicalize_prose_markup()` | 4184 | 102 lines |
| `_uncross_concealed_speech()` | 4308 | 69 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `track_background_presences()` | 1609 | 788 lines |
| `pick_voice_demand()` | 3202 | 421 lines |
| `promote_background_character()` | 3769 | 344 lines |
| `_fold_duplicate_presences()` | 740 | 143 lines |
| `descriptor_bindings()` | 2827 | 118 lines |
| `auto_promote_background_characters()` | 4152 | 94 lines |
| `addressed_rooms()` | 3113 | 87 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `prepare_scene_commit()` | 936 | 902 lines |
...
| `_report_started_sources()` | 876 | 58 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `_hear_level()` | 870 | 154 lines |
| `spatial_rel_between()` | 495 | 94 lines |
| `visual_level_between()` | 664 | 78 lines |
| `scent_level()` | 37 | 56 lines |
| `_clean_comms_channel()` | 158 | 53 lines |
| `_opening_view_cap()` | 610 | 52 lines |
| `comms_link()` | 297 | 49 lines |
| `hear_level()` | 815 | 45 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `claim_frontier_spaces()` | 1102 | 198 lines |
| `prepare_frontier_expansion()` | 895 | 142 lines |
| `materialize_planned_fringe()` | 398 | 121 lines |
| `plant_structure()` | 303 | 93 lines |
| `mint_frontier()` | 217 | 84 lines |
| `planned_context()` | 826 | 67 lines |
| `planned_room_brief()` | 636 | 62 lines |
| `structure_warnings()` | 1322 | 61 lines |
