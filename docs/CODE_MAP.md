...
| `world/charter_promote.py` | 438 |  | `world.charter_commitment`, `world.charter_feel`, `world.charter_politics`, `world.charter_social` |
...
| `acquainted()` | 390 | 49 lines |
| `promotion_handoff()` | 361 | 19 lines |
