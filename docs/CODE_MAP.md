...
| `prompts.py` | 2898 | Default system prompts and prompt preset access. | `db` |
...
| Function | Start | Size |
|---|---:|---:|
| `get_prompt()` | 2889 | 10 lines |
| `presets()` | 2880 | 2 lines |
| `active_preset()` | 2883 | 2 lines |
| `nsfw_enabled()` | 2886 | 2 lines |
