...
| `llm/schemas.py` | 5574 | Pydantic output contracts and semantic validation for agent payloads. | — |
| `mind/__init__.py` | 6 |  | — |
...
| Function | Start | Size |
|---|---:|---:|
| `preprocess_llm_output()` | 4275 | 344 lines |
| `_lenient_coerce()` | 745 | 159 lines |
| `validate_llm_output_strict()` | 5445 | 130 lines |
| `semantic_output_errors()` | 5238 | 112 lines |
| `canonicalize_prose_markup()` | 4080 | 102 lines |
| `_uncross_concealed_speech()` | 4204 | 69 lines |
| `_coerce_list_valued_map()` | 128 | 57 lines |
| `_coerce_conditions()` | 3621 | 55 lines |
