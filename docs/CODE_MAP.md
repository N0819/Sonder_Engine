...
| `persist/commit_background.py` | 4186 | Background presences: tracking, identity folding, the reactor gate, promotion to cast. | `core.db`, `mind.memory`, `persist.commit_common`, `story.character_schema`, `story.scene`, `world.spatial` |
...
| Function | Start | Size |
|---|---:|---:|
| `_commit_all_locked()` | 456 | 314 lines |
| `commit_crowds()` | 269 | 149 lines |
| `commit_authored_events()` | 215 | 30 lines |
| `commit_narration_person()` | 183 | 29 lines |
| `_prepare_turn_commit()` | 433 | 12 lines |
| `commit_offscreen_epoch()` | 247 | 11 lines |
| `commit_all()` | 420 | 11 lines |
| `commit_offscreen_plans()` | 260 | 7 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `track_background_presences()` | 1554 | 784 lines |
| `pick_voice_demand()` | 3143 | 421 lines |
| `promote_background_character()` | 3710 | 344 lines |
| `_fold_duplicate_presences()` | 685 | 143 lines |
| `descriptor_bindings()` | 2768 | 118 lines |
| `auto_promote_background_characters()` | 4093 | 94 lines |
| `addressed_rooms()` | 3054 | 87 lines |
| `_mint_missing_presence_names()` | 1470 | 82 lines |
