...
| `agents/common.py` | 5245 | Shared normalization, lore, delivery, and perception helpers. | `attire`, `character_schema`, `db`, `llm_quality`, `memory`, `providers`, `scene`, `schemas`, `spatial`, `theory_of_mind` |
| `agents/director.py` | 4305 | Scene establishment, player interpretation, and objective resolution. | `agents.common`, `attire`, `character_schema`, `db`, `memory`, `paradox`, `prompts`, `providers`, `scene`, `schemas`, `spatial` |
...
| `agents/perception.py` | 3502 | Opening, action-onset, and outcome observer views. | `affect`, `agents.common`, `character_schema`, `db`, `prompts`, `scene`, `spatial` |
...
| `commit.py` | 6453 | Validated persistence of scene, entities, cast, lore, relationships, events, and memories. | `affect`, `attire`, `character_schema`, `comfort`, `db`, `frames`, `mechanics`, `memory`, `paradox`, `prompts`, `providers`, `psychology_runtime`, `scene`, `spatial`, `spatial_frames`, `survival`, `theory_of_mind`, `weather` |
...
| `prompts.py` | 3837 | Default system prompts and prompt preset access. | `db` |
...
| `schemas.py` | 3792 | Pydantic output contracts and semantic validation for agent payloads. | — |
...
| Function | Start | Size |
|---|---:|---:|
| `norm_sequence()` | 1484 | 193 lines |
| `_scrub_invented_dialogue()` | 4138 | 145 lines |
| `_check_narrator_fidelity()` | 5059 | 123 lines |
| `_extract_authority_claims()` | 1014 | 106 lines |
| `_perceptible_entities()` | 592 | 98 lines |
| `_check_presence_knowledge_channel()` | 2948 | 95 lines |
| `region_visibility()` | 498 | 92 lines |
| `_check_quote_attribution()` | 4792 | 91 lines |

### `agents/director.py`

| Function | Start | Size |
|---|---:|---:|
| `director_resolve()` | 3201 | 1105 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `perception_outcome()` | 2748 | 755 lines |
| `perception_act()` | 2087 | 472 lines |
| `perception_establish()` | 1919 | 167 lines |
...
| `compact_line()` | 1278 | 108 lines |
| `decisive_targets()` | 845 | 89 lines |
| `dedupe_regions()` | 607 | 82 lines |
| `coerce_diff_shape()` | 739 | 77 lines |
| `resolve_garment()` | 537 | 68 lines |
| `apply_flat_change()` | 1059 | 66 lines |
| `advance()` | 936 | 56 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `prepare_memory_commit()` | 4929 | 1133 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `get_prompt()` | 3828 | 10 lines |
| `presets()` | 3819 | 2 lines |
| `active_preset()` | 3822 | 2 lines |
| `nsfw_enabled()` | 3825 | 2 lines |
...
| `semantic_output_errors()` | 3516 | 113 lines |
| `validate_llm_output_strict()` | 3691 | 102 lines |
