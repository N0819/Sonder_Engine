...
| `prompts.py` | 3865 | Default system prompts and prompt preset access. | `db` |
...
| Function | Start | Size |
|---|---:|---:|
| `get_prompt()` | 3856 | 10 lines |
| `presets()` | 3847 | 2 lines |
| `active_preset()` | 3850 | 2 lines |
| `nsfw_enabled()` | 3853 | 2 lines |
