...
| Function | Start | Size |
|---|---:|---:|
| `director_resolve()` | 6392 | 1376 lines |
| `director_interpret()` | 815 | 534 lines |
| `_reconcile_resolution()` | 4103 | 445 lines |
| `_reconcile_near_group_positions()` | 2399 | 276 lines |
| `_evidence_present()` | 3174 | 232 lines |
| `_run_specialists()` | 6028 | 211 lines |
| `_specialist_payload()` | 5809 | 133 lines |
| `_orchestration_scope_backstop()` | 6259 | 131 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `turn_branch()` | 4624 | 400 lines |
| `chat_get()` | 3025 | 234 lines |
| `_remap_cp_blob()` | 849 | 194 lines |
| `bootstrap()` | 1162 | 92 lines |
| `_stream()` | 462 | 91 lines |
| `lore_entry_edit()` | 2729 | 70 lines |
| `lore_edit()` | 2580 | 68 lines |
| `_ambience_payload()` | 5534 | 68 lines |
...
| PUT | `/api/active_preset` | `set_active()` | `app.py:1545` |
| PUT | `/api/affect_habituation` | `set_affect_habituation()` | `app.py:1840` |
| PUT | `/api/agent_models` | `put_agent_models()` | `app.py:1256` |
| PUT | `/api/ambience` | `put_ambience()` | `app.py:1369` |
| GET | `/api/ambience/library` | `ambience_library()` | `app.py:5692` |
| GET | `/api/ambience/search` | `ambience_search()` | `app.py:5671` |
| PUT | `/api/attire_beneath` | `set_attire_beneath()` | `app.py:1859` |
...
| GET | `/api/auto_promote` | `get_auto_promote()` | `app.py:3354` |
| PUT | `/api/auto_promote` | `set_auto_promote()` | `app.py:3358` |
| PUT | `/api/backdrops` | `put_backdrops()` | `app.py:1359` |
| GET | `/api/bootstrap` | `bootstrap()` | `app.py:1162` |
| POST | `/api/characters` | `char_create()` | `app.py:2315` |
| POST | `/api/characters/generate` | `char_generate()` | `app.py:2293` |
| POST | `/api/characters/import` | `char_import()` | `app.py:2336` |
| DELETE | `/api/characters/{cid}` | `char_del()` | `app.py:2451` |
| PUT | `/api/characters/{cid}` | `char_edit()` | `app.py:2442` |
| GET | `/api/characters/{cid}/export` | `char_export()` | `app.py:2434` |
| POST | `/api/characters/{cid}/fill_appearance` | `char_fill_appearance()` | `app.py:2424` |
| POST | `/api/characters/{cid}/fill_psychology` | `char_fill_psychology()` | `app.py:2396` |
| POST | `/api/characters/{cid}/generate_greeting` | `char_generate_greeting()` | `app.py:2380` |
| POST | `/api/characters/{cid}/recover_greetings` | `char_recover_greetings()` | `app.py:2370` |
| POST | `/api/characters/{cid}/start` | `character_start_story()` | `app.py:2351` |
| POST | `/api/chats` | `chat_new()` | `app.py:2808` |
| POST | `/api/chats/import` | `import_chat()` | `chat_archive.py:175` |
| DELETE | `/api/chats/{cid}` | `chat_del()` | `app.py:2995` |
| GET | `/api/chats/{cid}` | `chat_get()` | `app.py:3025` |
| PUT | `/api/chats/{cid}` | `chat_edit()` | `app.py:2899` |
| POST | `/api/chats/{cid}/abort` | `chat_abort()` | `app.py:4620` |
| GET | `/api/chats/{cid}/ambience/oneshot/{name}` | `ambience_oneshot()` | `app.py:5701` |
| DELETE | `/api/chats/{cid}/ambience/pin` | `ambience_pin_delete()` | `app.py:5749` |
| PUT | `/api/chats/{cid}/ambience/pin` | `ambience_pin_put()` | `app.py:5730` |
| GET | `/api/chats/{cid}/ambience/pins` | `ambience_pins_get()` | `app.py:5725` |
| GET | `/api/chats/{cid}/ambience/{signature}.audio` | `ambience_audio()` | `app.py:5655` |
| GET | `/api/chats/{cid}/attire` | `attire_get()` | `app.py:4032` |
| PUT | `/api/chats/{cid}/attire` | `attire_put()` | `app.py:4039` |
| GET | `/api/chats/{cid}/backdrop/{signature}.png` | `backdrop_image()` | `app.py:5502` |
| GET | `/api/chats/{cid}/background_config` | `bg_cfg_get()` | `app.py:4173` |
| PUT | `/api/chats/{cid}/background_config` | `bg_cfg_put()` | `app.py:4177` |
| POST | `/api/chats/{cid}/characters` | `chat_add_char()` | `app.py:3261` |
| DELETE | `/api/chats/{cid}/characters/{ch}` | `chat_del_char()` | `app.py:3623` |
| PUT | `/api/chats/{cid}/characters/{ch}/card` | `chat_char_card_put()` | `app.py:3633` |
| PUT | `/api/chats/{cid}/characters/{ch}/dialogue_color` | `dialogue_color_put()` | `app.py:3922` |
| GET | `/api/chats/{cid}/characters/{ch}/memories` | `mem_list()` | `app.py:4371` |
| POST | `/api/chats/{cid}/characters/{ch}/memories` | `mem_add()` | `app.py:4507` |
| POST | `/api/chats/{cid}/characters/{ch}/memories/backfill` | `mem_backfill()` | `app.py:4477` |
| POST | `/api/chats/{cid}/characters/{ch}/memories/consolidate` | `mem_consolidate()` | `app.py:4462` |
| GET | `/api/chats/{cid}/characters/{ch}/memories/coverage` | `mem_coverage()` | `app.py:4498` |
| GET | `/api/chats/{cid}/characters/{ch}/memories/export` | `mem_export()` | `app.py:4417` |
| POST | `/api/chats/{cid}/characters/{ch}/memories/import` | `mem_import()` | `app.py:4428` |
| GET | `/api/chats/{cid}/characters/{ch}/memories/search` | `mem_search()` | `app.py:4392` |
| GET | `/api/chats/{cid}/characters/{ch}/memory-context` | `memory_context_preview()` | `app.py:4438` |
| PUT | `/api/chats/{cid}/characters/{ch}/position` | `chat_char_position_put()` | `app.py:3839` |
| GET | `/api/chats/{cid}/characters/{ch}/private_history` | `ph_get()` | `app.py:3903` |
| PUT | `/api/chats/{cid}/characters/{ch}/private_history` | `ph_put()` | `app.py:3913` |
| GET | `/api/chats/{cid}/characters/{ch}/relationships` | `relationships_get()` | `app.py:4451` |
| GET | `/api/chats/{cid}/dialogue_config` | `dlg_get()` | `app.py:4074` |
| PUT | `/api/chats/{cid}/dialogue_config` | `dlg_put()` | `app.py:4091` |
| GET | `/api/chats/{cid}/dramatic_irony` | `get_dramatic_irony_feed()` | `app.py:3315` |
| GET | `/api/chats/{cid}/export` | `export_chat()` | `chat_archive.py:169` |
| GET | `/api/chats/{cid}/fixed_points` | `fixed_points_list()` | `app.py:4317` |
| POST | `/api/chats/{cid}/fixed_points` | `fixed_points_create()` | `app.py:4327` |
| DELETE | `/api/chats/{cid}/fixed_points/{anchor_id}` | `fixed_points_delete()` | `app.py:4349` |
| GET | `/api/chats/{cid}/frames` | `frames_list()` | `app.py:4271` |
| POST | `/api/chats/{cid}/frames` | `frames_create()` | `app.py:4275` |
| GET | `/api/chats/{cid}/guest_invites` | `list_guest_invites()` | `app.py:3502` |
| POST | `/api/chats/{cid}/guest_invites` | `create_guest_invite()` | `app.py:3484` |
| DELETE | `/api/chats/{cid}/guest_invites/{gid}` | `revoke_guest_invite()` | `app.py:3506` |
| GET | `/api/chats/{cid}/language` | `chat_language_get()` | `app.py:2866` |
| PUT | `/api/chats/{cid}/language` | `chat_language_put()` | `app.py:2883` |
| GET | `/api/chats/{cid}/living_world` | `living_world_get()` | `app.py:4138` |
| PUT | `/api/chats/{cid}/living_world` | `living_world_put()` | `app.py:4161` |
| DELETE | `/api/chats/{cid}/lorebook` | `detach_lore()` | `app.py:2986` |
| POST | `/api/chats/{cid}/lorebook` | `bind_lore()` | `app.py:2970` |
| GET | `/api/chats/{cid}/lorebooks` | `chat_lorebooks_owned()` | `app.py:1944` |
| POST | `/api/chats/{cid}/lorebooks` | `attach_lore()` | `app.py:2930` |
| DELETE | `/api/chats/{cid}/lorebooks/{lid}` | `detach_book()` | `app.py:2955` |
| GET | `/api/chats/{cid}/paradox_policy` | `paradox_policy_get()` | `app.py:4302` |
| PUT | `/api/chats/{cid}/paradox_policy` | `paradox_policy_put()` | `app.py:4306` |
| GET | `/api/chats/{cid}/persona_private_history` | `pph_get()` | `app.py:3974` |
| PUT | `/api/chats/{cid}/persona_private_history` | `pph_put()` | `app.py:3987` |
| GET | `/api/chats/{cid}/personas` | `chat_list_extra_personas()` | `app.py:3363` |
| POST | `/api/chats/{cid}/personas` | `chat_add_persona()` | `app.py:3408` |
| DELETE | `/api/chats/{cid}/personas/{pid}` | `chat_del_persona()` | `app.py:3432` |
| PUT | `/api/chats/{cid}/personas/{pid}/station` | `chat_persona_station()` | `app.py:3373` |
| GET | `/api/chats/{cid}/player_authority` | `player_authority_get()` | `app.py:4234` |
| PUT | `/api/chats/{cid}/player_authority` | `player_authority_put()` | `app.py:4249` |
| GET | `/api/chats/{cid}/player_view` | `player_view_get()` | `app.py:4218` |
| GET | `/api/chats/{cid}/positions` | `chat_positions_get()` | `app.py:3775` |
| GET | `/api/chats/{cid}/promises` | `get_promise_ledger()` | `app.py:3319` |
| GET | `/api/chats/{cid}/promotable` | `list_promotable_presences()` | `app.py:3311` |
| POST | `/api/chats/{cid}/promotions/confirm` | `confirm_promotion()` | `app.py:3337` |
| POST | `/api/chats/{cid}/promotions/draft` | `draft_promotion()` | `app.py:3323` |
| GET | `/api/chats/{cid}/story_view` | `story_view_get()` | `app.py:4203` |
| GET | `/api/chats/{cid}/style_guide` | `style_guide_get()` | `app.py:4057` |
| PUT | `/api/chats/{cid}/style_guide` | `style_guide_put()` | `app.py:4063` |
| GET | `/api/chats/{cid}/survival` | `survival_get()` | `app.py:3690` |
| PUT | `/api/chats/{cid}/survival` | `survival_put()` | `app.py:3695` |
| POST | `/api/chats/{cid}/turns` | `turn_new()` | `app.py:4560` |
| POST | `/api/chats/{cid}/turns/{idx}/player_input` | `submit_extra_player_input()` | `app.py:3446` |
| GET | `/api/chats/{cid}/viewers` | `viewers_get()` | `app.py:4228` |
| GET | `/api/chats/{cid}/vitals` | `chat_vitals_get()` | `app.py:3742` |
| GET | `/api/chats/{cid}/world` | `world_get()` | `app.py:3992` |
| PUT | `/api/chats/{cid}/world` | `world_put()` | `app.py:3996` |
| GET | `/api/default_prompts` | `default_prompts()` | `app.py:1483` |
| PUT | `/api/director_fanout_mode` | `set_director_fanout_mode()` | `app.py:1816` |
| PUT | `/api/exemplars` | `put_exemplars()` | `app.py:1328` |
| GET | `/api/extensions` | `extensions_list()` | `app.py:1562` |
| POST | `/api/extensions/install` | `extension_install()` | `app.py:1577` |
| GET | `/api/extensions/ui.css` | `extensions_ui_css()` | `app.py:1737` |
| GET | `/api/extensions/ui.js` | `extensions_ui()` | `app.py:1728` |
| GET | `/api/extensions/updates` | `extension_updates()` | `app.py:1598` |
| DELETE | `/api/extensions/{eid}` | `extension_remove()` | `app.py:1619` |
| GET | `/api/extensions/{eid}/asset/{path:path}` | `extension_asset()` | `app.py:1792` |
| POST | `/api/extensions/{eid}/disable` | `extension_disable()` | `app.py:1627` |
| DELETE | `/api/extensions/{eid}/document` | `extension_document_delete()` | `app.py:1705` |
| GET | `/api/extensions/{eid}/document` | `extension_document_get()` | `app.py:1673` |
| PUT | `/api/extensions/{eid}/document` | `extension_document_put()` | `app.py:1685` |
| DELETE | `/api/extensions/{eid}/documents` | `extension_documents_delete()` | `app.py:1715` |
| GET | `/api/extensions/{eid}/documents` | `extension_documents_list()` | `app.py:1652` |
| GET | `/api/extensions/{eid}/documents/verify` | `extension_documents_verify()` | `app.py:1663` |
| POST | `/api/extensions/{eid}/enable` | `extension_enable()` | `app.py:1569` |
| GET | `/api/extensions/{eid}/state` | `extension_state()` | `app.py:1632` |
| GET | `/api/extensions/{eid}/ui.css` | `extension_ui_css_one()` | `app.py:1759` |
| GET | `/api/extensions/{eid}/ui.js` | `extension_ui_one()` | `app.py:1747` |
| POST | `/api/extensions/{eid}/update` | `extension_update()` | `app.py:1609` |
| POST | `/api/guest/input` | `guest_input()` | `app.py:3598` |
| GET | `/api/guest/state` | `guest_state()` | `app.py:3530` |
| PUT | `/api/image_model` | `put_image_model()` | `app.py:1306` |
| POST | `/api/join` | `join_with_code()` | `app.py:3512` |
| GET | `/api/language-packs` | `language_packs_get()` | `app.py:2826` |
| GET | `/api/language-packs/{language_id}/ui` | `language_pack_ui()` | `app.py:2843` |
| DELETE | `/api/lore_entries/{eid}` | `lore_entry_delete()` | `app.py:2801` |
| PUT | `/api/lore_entries/{eid}` | `lore_entry_edit()` | `app.py:2729` |
| DELETE | `/api/lore_gen_jobs/{job_id}` | `lorebook_generate_discard()` | `app.py:2100` |
| POST | `/api/lore_gen_jobs/{job_id}/resume` | `lorebook_generate_resume()` | `app.py:2082` |
| DELETE | `/api/lorebook_links/{link_id}` | `lorebook_link_delete()` | `app.py:2040` |
| PUT | `/api/lorebook_links/{link_id}` | `lorebook_link_update()` | `app.py:2026` |
| POST | `/api/lorebooks` | `lore_create()` | `app.py:2558` |
| POST | `/api/lorebooks/import` | `lore_import()` | `app.py:2136` |
| DELETE | `/api/lorebooks/{lid}` | `lore_delete()` | `app.py:2650` |
| GET | `/api/lorebooks/{lid}` | `lore_get()` | `app.py:2538` |
| PUT | `/api/lorebooks/{lid}` | `lore_edit()` | `app.py:2580` |
| POST | `/api/lorebooks/{lid}/apply_plan` | `lorebook_apply_plan()` | `app.py:2109` |
| POST | `/api/lorebooks/{lid}/entries` | `lore_entry_create()` | `app.py:2700` |
| GET | `/api/lorebooks/{lid}/export` | `lore_export()` | `app.py:2656` |
| POST | `/api/lorebooks/{lid}/generate` | `lore_generate()` | `app.py:2686` |
| GET | `/api/lorebooks/{lid}/generate_job` | `lorebook_generate_job()` | `app.py:2071` |
| POST | `/api/lorebooks/{lid}/generate_plan` | `lorebook_generate_plan()` | `app.py:2045` |
| GET | `/api/lorebooks/{lid}/links` | `lorebook_links_get()` | `app.py:1999` |
| POST | `/api/lorebooks/{lid}/links` | `lorebook_link_create()` | `app.py:2004` |
| POST | `/api/lorebooks/{lid}/move` | `lorebook_move()` | `app.py:1926` |
| POST | `/api/lorebooks/{lid}/reinterpret` | `lore_reinterpret_route()` | `app.py:2673` |
| POST | `/api/lorebooks/{lid}/reorder` | `lorebook_reorder()` | `app.py:1935` |
| GET | `/api/maintenance/checkpoints` | `maintenance_checkpoints()` | `app.py:1882` |
| POST | `/api/maintenance/checkpoints/compact` | `maintenance_compact()` | `app.py:1898` |
| PUT | `/api/max_output_tokens` | `put_max_output_tokens()` | `app.py:1450` |
| DELETE | `/api/memories/{mid}` | `mem_del()` | `app.py:4554` |
| PUT | `/api/memories/{mid}` | `mem_edit()` | `app.py:4533` |
| GET | `/api/memory/embeddings` | `memory_embeddings_status()` | `app.py:1279` |
| POST | `/api/memory/embeddings/rebuild` | `memory_embeddings_rebuild()` | `app.py:1294` |
| GET | `/api/nsfw` | `get_nsfw()` | `app.py:1807` |
| PUT | `/api/nsfw` | `set_nsfw()` | `app.py:1811` |
| GET | `/api/openrouter/endpoints` | `get_openrouter_endpoints()` | `app.py:1413` |
| PUT | `/api/openrouter_routing` | `put_openrouter_routing()` | `app.py:1399` |
| POST | `/api/personas` | `persona_create()` | `app.py:2480` |
| POST | `/api/personas/generate` | `persona_generate()` | `app.py:2458` |
| POST | `/api/personas/import` | `persona_import()` | `app.py:2500` |
| DELETE | `/api/personas/{pid}` | `persona_del()` | `app.py:2532` |
| PUT | `/api/personas/{pid}` | `persona_edit()` | `app.py:2523` |
| GET | `/api/personas/{pid}/export` | `persona_export()` | `app.py:2514` |
| POST | `/api/personas/{pid}/fill_appearance` | `persona_fill_appearance()` | `app.py:2429` |
| PUT | `/api/prompt_presets` | `save_preset()` | `app.py:1494` |
| POST | `/api/prompt_presets/import` | `import_preset()` | `app.py:1522` |
| DELETE | `/api/prompt_presets/{name}` | `del_preset()` | `app.py:1536` |
| GET | `/api/prompt_presets/{name}/export` | `export_preset()` | `app.py:1513` |
| POST | `/api/providers` | `add_provider()` | `app.py:2192` |
| DELETE | `/api/providers/{pid}` | `del_provider()` | `app.py:2271` |
| PUT | `/api/providers/{pid}` | `put_provider()` | `app.py:2199` |
| GET | `/api/providers/{pid}/image_models` | `image_models()` | `app.py:2283` |
| GET | `/api/providers/{pid}/models` | `models()` | `app.py:2276` |
| PUT | `/api/providers/{pid}/prompt_cache` | `put_provider_prompt_cache()` | `app.py:2226` |
| PUT | `/api/reasoning_effort` | `put_reasoning_effort()` | `app.py:1425` |
| POST | `/api/steps/{sid}/activate` | `step_activate()` | `app.py:5333` |
| POST | `/api/steps/{sid}/edit` | `step_edit()` | `app.py:5323` |
| POST | `/api/steps/{sid}/reroll` | `step_reroll()` | `app.py:5276` |
| DELETE | `/api/turns/{tid}` | `turn_del()` | `app.py:5346` |
| GET | `/api/turns/{tid}/ambience` | `turn_ambience()` | `app.py:5605` |
| POST | `/api/turns/{tid}/ambience` | `turn_ambience_resolve()` | `app.py:5622` |
| GET | `/api/turns/{tid}/backdrop` | `turn_backdrop()` | `app.py:5427` |
| POST | `/api/turns/{tid}/backdrop` | `turn_backdrop_generate()` | `app.py:5475` |
| POST | `/api/turns/{tid}/branch` | `turn_branch()` | `app.py:4624` |
| PUT | `/api/turns/{tid}/input` | `edit_input()` | `app.py:5026` |
| GET | `/api/turns/{tid}/narration` | `turn_narration_variants()` | `app.py:5093` |
| POST | `/api/turns/{tid}/narration` | `turn_narration_select()` | `app.py:5114` |
| GET | `/api/turns/{tid}/pipeline` | `pipeline_get()` | `app.py:5138` |
| PUT | `/api/turns/{tid}/prose` | `edit_prose()` | `app.py:5041` |
| POST | `/api/turns/{tid}/reroll` | `turn_reroll()` | `app.py:5207` |
| POST | `/api/turns/{tid}/rerun` | `turn_rerun()` | `app.py:5217` |
| POST | `/api/turns/{tid}/resume` | `turn_resume()` | `app.py:5244` |
| GET | `/api/ui` | `ui_catalog_get()` | `app.py:2833` |
| PUT | `/api/ui-language` | `ui_language_put()` | `app.py:2855` |
| GET | `/api/updates/check` | `updates_check()` | `app.py:1874` |
| POST | `/api/updates/install` | `updates_install()` | `app.py:1878` |
