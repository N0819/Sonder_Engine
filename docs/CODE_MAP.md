...
| `agents/director.py` | 4571 | Scene establishment, player interpretation, and objective resolution. | `agents.common`, `agents.director_contact`, `agents.director_evidence`, `agents.director_fanout`, `agents.director_floors`, `agents.director_lingua`, `agents.director_movement`, `agents.director_reconcile`, `agents.director_scopes`, `agents.director_views`, `core.db`, `llm`, `llm.prompts`, `llm.providers`, `llm.schemas`, `mind.memory`, `story`, `story.attire`, `story.character_schema`, `story.scene`, `world.paradox`, `world.spatial`, `world.survival` |
...
| `world/charter_model.py` | 702 |  | `world.charter_chatter`, `world.charter_figure`, `world.charter_harm`, `world.charter_mark` |
...
| `world/charter_runtime.py` | 3808 |  | `core`, `core.logging_utils`, `world.charter`, `world.charter_news`, `world.day_cycle`, `world.mechanics` |
...
| Function | Start | Size |
|---|---:|---:|
| `director_resolve()` | 2755 | 1783 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `normalize_charter()` | 339 | 342 lines |
| `normalize_body()` | 171 | 97 lines |
| `body_of_an_authored_mind()` | 270 | 45 lines |
| `normalize_upkeep()` | 111 | 31 lines |
| `normalize_post()` | 144 | 25 lines |
| `_tags()` | 72 | 15 lines |
| `_string_list()` | 94 | 15 lines |
| `_optional_float()` | 329 | 8 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `registry_warnings()` | 1774 | 182 lines |
| `_prepare_cast_histories()` | 645 | 172 lines |
| `_plan_lived_location()` | 1379 | 159 lines |
| `advance_snapshot()` | 2080 | 153 lines |
| `_generate_lived_location()` | 1598 | 122 lines |
| `presence_view()` | 3152 | 110 lines |
| `presim_registry()` | 961 | 104 lines |
| `generation_lore()` | 1067 | 101 lines |
