...
| Function | Start | Size |
|---|---:|---:|
| `turn_branch()` | 4555 | 400 lines |
| `chat_get()` | 2956 | 234 lines |
| `_remap_cp_blob()` | 849 | 194 lines |
| `bootstrap()` | 1163 | 98 lines |
| `_stream()` | 462 | 91 lines |
| `lore_entry_edit()` | 2660 | 70 lines |
| `lore_edit()` | 2511 | 68 lines |
| `_ambience_payload()` | 5465 | 68 lines |
...
| PUT | `/api/affect_habituation` | `set_affect_habituation()` | `app.py:1771` |
| PUT | `/api/agent_models` | `put_agent_models()` | `app.py:1263` |
| PUT | `/api/ambience` | `put_ambience()` | `app.py:1384` |
| GET | `/api/ambience/library` | `ambience_library()` | `app.py:5623` |
| GET | `/api/ambience/search` | `ambience_search()` | `app.py:5602` |
| PUT | `/api/attire_beneath` | `set_attire_beneath()` | `app.py:1790` |
...
| GET | `/api/auto_promote` | `get_auto_promote()` | `app.py:3285` |
| PUT | `/api/auto_promote` | `set_auto_promote()` | `app.py:3289` |
| PUT | `/api/backdrops` | `put_backdrops()` | `app.py:1374` |
| GET | `/api/bootstrap` | `bootstrap()` | `app.py:1163` |
| POST | `/api/characters` | `char_create()` | `app.py:2246` |
| POST | `/api/characters/generate` | `char_generate()` | `app.py:2224` |
| POST | `/api/characters/import` | `char_import()` | `app.py:2267` |
| DELETE | `/api/characters/{cid}` | `char_del()` | `app.py:2382` |
| PUT | `/api/characters/{cid}` | `char_edit()` | `app.py:2373` |
| GET | `/api/characters/{cid}/export` | `char_export()` | `app.py:2365` |
| POST | `/api/characters/{cid}/fill_appearance` | `char_fill_appearance()` | `app.py:2355` |
| POST | `/api/characters/{cid}/fill_psychology` | `char_fill_psychology()` | `app.py:2327` |
| POST | `/api/characters/{cid}/generate_greeting` | `char_generate_greeting()` | `app.py:2311` |
| POST | `/api/characters/{cid}/recover_greetings` | `char_recover_greetings()` | `app.py:2301` |
| POST | `/api/characters/{cid}/start` | `character_start_story()` | `app.py:2282` |
| POST | `/api/chats` | `chat_new()` | `app.py:2739` |
| POST | `/api/chats/import` | `import_chat()` | `chat_archive.py:175` |
| DELETE | `/api/chats/{cid}` | `chat_del()` | `app.py:2926` |
| GET | `/api/chats/{cid}` | `chat_get()` | `app.py:2956` |
| PUT | `/api/chats/{cid}` | `chat_edit()` | `app.py:2830` |
| POST | `/api/chats/{cid}/abort` | `chat_abort()` | `app.py:4551` |
| GET | `/api/chats/{cid}/ambience/oneshot/{name}` | `ambience_oneshot()` | `app.py:5632` |
| DELETE | `/api/chats/{cid}/ambience/pin` | `ambience_pin_delete()` | `app.py:5680` |
| PUT | `/api/chats/{cid}/ambience/pin` | `ambience_pin_put()` | `app.py:5661` |
| GET | `/api/chats/{cid}/ambience/pins` | `ambience_pins_get()` | `app.py:5656` |
| GET | `/api/chats/{cid}/ambience/{signature}.audio` | `ambience_audio()` | `app.py:5586` |
| GET | `/api/chats/{cid}/attire` | `attire_get()` | `app.py:3963` |
| PUT | `/api/chats/{cid}/attire` | `attire_put()` | `app.py:3970` |
| GET | `/api/chats/{cid}/backdrop/{signature}.png` | `backdrop_image()` | `app.py:5433` |
| GET | `/api/chats/{cid}/background_config` | `bg_cfg_get()` | `app.py:4104` |
| PUT | `/api/chats/{cid}/background_config` | `bg_cfg_put()` | `app.py:4108` |
| POST | `/api/chats/{cid}/characters` | `chat_add_char()` | `app.py:3192` |
| DELETE | `/api/chats/{cid}/characters/{ch}` | `chat_del_char()` | `app.py:3554` |
| PUT | `/api/chats/{cid}/characters/{ch}/card` | `chat_char_card_put()` | `app.py:3564` |
| PUT | `/api/chats/{cid}/characters/{ch}/dialogue_color` | `dialogue_color_put()` | `app.py:3853` |
| GET | `/api/chats/{cid}/characters/{ch}/memories` | `mem_list()` | `app.py:4302` |
| POST | `/api/chats/{cid}/characters/{ch}/memories` | `mem_add()` | `app.py:4438` |
| POST | `/api/chats/{cid}/characters/{ch}/memories/backfill` | `mem_backfill()` | `app.py:4408` |
| POST | `/api/chats/{cid}/characters/{ch}/memories/consolidate` | `mem_consolidate()` | `app.py:4393` |
| GET | `/api/chats/{cid}/characters/{ch}/memories/coverage` | `mem_coverage()` | `app.py:4429` |
| GET | `/api/chats/{cid}/characters/{ch}/memories/export` | `mem_export()` | `app.py:4348` |
| POST | `/api/chats/{cid}/characters/{ch}/memories/import` | `mem_import()` | `app.py:4359` |
| GET | `/api/chats/{cid}/characters/{ch}/memories/search` | `mem_search()` | `app.py:4323` |
| GET | `/api/chats/{cid}/characters/{ch}/memory-context` | `memory_context_preview()` | `app.py:4369` |
| PUT | `/api/chats/{cid}/characters/{ch}/position` | `chat_char_position_put()` | `app.py:3770` |
| GET | `/api/chats/{cid}/characters/{ch}/private_history` | `ph_get()` | `app.py:3834` |
| PUT | `/api/chats/{cid}/characters/{ch}/private_history` | `ph_put()` | `app.py:3844` |
| GET | `/api/chats/{cid}/characters/{ch}/relationships` | `relationships_get()` | `app.py:4382` |
| GET | `/api/chats/{cid}/dialogue_config` | `dlg_get()` | `app.py:4005` |
| PUT | `/api/chats/{cid}/dialogue_config` | `dlg_put()` | `app.py:4022` |
| GET | `/api/chats/{cid}/dramatic_irony` | `get_dramatic_irony_feed()` | `app.py:3246` |
| GET | `/api/chats/{cid}/export` | `export_chat()` | `chat_archive.py:169` |
| GET | `/api/chats/{cid}/fixed_points` | `fixed_points_list()` | `app.py:4248` |
| POST | `/api/chats/{cid}/fixed_points` | `fixed_points_create()` | `app.py:4258` |
| DELETE | `/api/chats/{cid}/fixed_points/{anchor_id}` | `fixed_points_delete()` | `app.py:4280` |
| GET | `/api/chats/{cid}/frames` | `frames_list()` | `app.py:4202` |
| POST | `/api/chats/{cid}/frames` | `frames_create()` | `app.py:4206` |
| GET | `/api/chats/{cid}/guest_invites` | `list_guest_invites()` | `app.py:3433` |
| POST | `/api/chats/{cid}/guest_invites` | `create_guest_invite()` | `app.py:3415` |
| DELETE | `/api/chats/{cid}/guest_invites/{gid}` | `revoke_guest_invite()` | `app.py:3437` |
| GET | `/api/chats/{cid}/language` | `chat_language_get()` | `app.py:2797` |
| PUT | `/api/chats/{cid}/language` | `chat_language_put()` | `app.py:2814` |
| GET | `/api/chats/{cid}/living_world` | `living_world_get()` | `app.py:4069` |
| PUT | `/api/chats/{cid}/living_world` | `living_world_put()` | `app.py:4092` |
| DELETE | `/api/chats/{cid}/lorebook` | `detach_lore()` | `app.py:2917` |
| POST | `/api/chats/{cid}/lorebook` | `bind_lore()` | `app.py:2901` |
| GET | `/api/chats/{cid}/lorebooks` | `chat_lorebooks_owned()` | `app.py:1875` |
| POST | `/api/chats/{cid}/lorebooks` | `attach_lore()` | `app.py:2861` |
| DELETE | `/api/chats/{cid}/lorebooks/{lid}` | `detach_book()` | `app.py:2886` |
| GET | `/api/chats/{cid}/paradox_policy` | `paradox_policy_get()` | `app.py:4233` |
| PUT | `/api/chats/{cid}/paradox_policy` | `paradox_policy_put()` | `app.py:4237` |
| GET | `/api/chats/{cid}/persona_private_history` | `pph_get()` | `app.py:3905` |
| PUT | `/api/chats/{cid}/persona_private_history` | `pph_put()` | `app.py:3918` |
| GET | `/api/chats/{cid}/personas` | `chat_list_extra_personas()` | `app.py:3294` |
| POST | `/api/chats/{cid}/personas` | `chat_add_persona()` | `app.py:3339` |
| DELETE | `/api/chats/{cid}/personas/{pid}` | `chat_del_persona()` | `app.py:3363` |
| PUT | `/api/chats/{cid}/personas/{pid}/station` | `chat_persona_station()` | `app.py:3304` |
| GET | `/api/chats/{cid}/player_authority` | `player_authority_get()` | `app.py:4165` |
| PUT | `/api/chats/{cid}/player_authority` | `player_authority_put()` | `app.py:4180` |
| GET | `/api/chats/{cid}/player_view` | `player_view_get()` | `app.py:4149` |
| GET | `/api/chats/{cid}/positions` | `chat_positions_get()` | `app.py:3706` |
| GET | `/api/chats/{cid}/promises` | `get_promise_ledger()` | `app.py:3250` |
| GET | `/api/chats/{cid}/promotable` | `list_promotable_presences()` | `app.py:3242` |
| POST | `/api/chats/{cid}/promotions/confirm` | `confirm_promotion()` | `app.py:3268` |
| POST | `/api/chats/{cid}/promotions/draft` | `draft_promotion()` | `app.py:3254` |
| GET | `/api/chats/{cid}/story_view` | `story_view_get()` | `app.py:4134` |
| GET | `/api/chats/{cid}/style_guide` | `style_guide_get()` | `app.py:3988` |
| PUT | `/api/chats/{cid}/style_guide` | `style_guide_put()` | `app.py:3994` |
| GET | `/api/chats/{cid}/survival` | `survival_get()` | `app.py:3621` |
| PUT | `/api/chats/{cid}/survival` | `survival_put()` | `app.py:3626` |
| POST | `/api/chats/{cid}/turns` | `turn_new()` | `app.py:4491` |
| POST | `/api/chats/{cid}/turns/{idx}/player_input` | `submit_extra_player_input()` | `app.py:3377` |
| GET | `/api/chats/{cid}/viewers` | `viewers_get()` | `app.py:4159` |
| GET | `/api/chats/{cid}/vitals` | `chat_vitals_get()` | `app.py:3673` |
| GET | `/api/chats/{cid}/world` | `world_get()` | `app.py:3923` |
| PUT | `/api/chats/{cid}/world` | `world_put()` | `app.py:3927` |
| GET | `/api/default_prompts` | `default_prompts()` | `app.py:1503` |
| PUT | `/api/director_fanout_mode` | `set_director_fanout_mode()` | `app.py:1747` |
...
| GET | `/api/extensions/ui.css` | `extensions_ui_css()` | `app.py:1668` |
| GET | `/api/extensions/ui.js` | `extensions_ui()` | `app.py:1659` |
| GET | `/api/extensions/updates` | `extension_updates()` | `app.py:1618` |
| DELETE | `/api/extensions/{eid}` | `extension_remove()` | `app.py:1639` |
| GET | `/api/extensions/{eid}/asset/{path:path}` | `extension_asset()` | `app.py:1723` |
...
| GET | `/api/extensions/{eid}/ui.css` | `extension_ui_css_one()` | `app.py:1690` |
| GET | `/api/extensions/{eid}/ui.js` | `extension_ui_one()` | `app.py:1678` |
| POST | `/api/extensions/{eid}/update` | `extension_update()` | `app.py:1629` |
| POST | `/api/guest/input` | `guest_input()` | `app.py:3529` |
| GET | `/api/guest/state` | `guest_state()` | `app.py:3461` |
| PUT | `/api/image_model` | `put_image_model()` | `app.py:1321` |
| POST | `/api/join` | `join_with_code()` | `app.py:3443` |
| GET | `/api/language-packs` | `language_packs_get()` | `app.py:2757` |
| GET | `/api/language-packs/{language_id}/ui` | `language_pack_ui()` | `app.py:2774` |
| DELETE | `/api/lore_entries/{eid}` | `lore_entry_delete()` | `app.py:2732` |
| PUT | `/api/lore_entries/{eid}` | `lore_entry_edit()` | `app.py:2660` |
| DELETE | `/api/lore_gen_jobs/{job_id}` | `lorebook_generate_discard()` | `app.py:2031` |
| POST | `/api/lore_gen_jobs/{job_id}/resume` | `lorebook_generate_resume()` | `app.py:2013` |
| DELETE | `/api/lorebook_links/{link_id}` | `lorebook_link_delete()` | `app.py:1971` |
| PUT | `/api/lorebook_links/{link_id}` | `lorebook_link_update()` | `app.py:1957` |
| POST | `/api/lorebooks` | `lore_create()` | `app.py:2489` |
| POST | `/api/lorebooks/import` | `lore_import()` | `app.py:2067` |
| DELETE | `/api/lorebooks/{lid}` | `lore_delete()` | `app.py:2581` |
| GET | `/api/lorebooks/{lid}` | `lore_get()` | `app.py:2469` |
| PUT | `/api/lorebooks/{lid}` | `lore_edit()` | `app.py:2511` |
| POST | `/api/lorebooks/{lid}/apply_plan` | `lorebook_apply_plan()` | `app.py:2040` |
| POST | `/api/lorebooks/{lid}/entries` | `lore_entry_create()` | `app.py:2631` |
| GET | `/api/lorebooks/{lid}/export` | `lore_export()` | `app.py:2587` |
| POST | `/api/lorebooks/{lid}/generate` | `lore_generate()` | `app.py:2617` |
| GET | `/api/lorebooks/{lid}/generate_job` | `lorebook_generate_job()` | `app.py:2002` |
| POST | `/api/lorebooks/{lid}/generate_plan` | `lorebook_generate_plan()` | `app.py:1976` |
| GET | `/api/lorebooks/{lid}/links` | `lorebook_links_get()` | `app.py:1930` |
| POST | `/api/lorebooks/{lid}/links` | `lorebook_link_create()` | `app.py:1935` |
| POST | `/api/lorebooks/{lid}/move` | `lorebook_move()` | `app.py:1857` |
| POST | `/api/lorebooks/{lid}/reinterpret` | `lore_reinterpret_route()` | `app.py:2604` |
| POST | `/api/lorebooks/{lid}/reorder` | `lorebook_reorder()` | `app.py:1866` |
| GET | `/api/maintenance/checkpoints` | `maintenance_checkpoints()` | `app.py:1813` |
| POST | `/api/maintenance/checkpoints/compact` | `maintenance_compact()` | `app.py:1829` |
| PUT | `/api/max_output_tokens` | `put_max_output_tokens()` | `app.py:1470` |
| DELETE | `/api/memories/{mid}` | `mem_del()` | `app.py:4485` |
| PUT | `/api/memories/{mid}` | `mem_edit()` | `app.py:4464` |
...
| GET | `/api/nsfw` | `get_nsfw()` | `app.py:1738` |
| PUT | `/api/nsfw` | `set_nsfw()` | `app.py:1742` |
...
| POST | `/api/personas` | `persona_create()` | `app.py:2411` |
| POST | `/api/personas/generate` | `persona_generate()` | `app.py:2389` |
| POST | `/api/personas/import` | `persona_import()` | `app.py:2431` |
| DELETE | `/api/personas/{pid}` | `persona_del()` | `app.py:2463` |
| PUT | `/api/personas/{pid}` | `persona_edit()` | `app.py:2454` |
| GET | `/api/personas/{pid}/export` | `persona_export()` | `app.py:2445` |
| POST | `/api/personas/{pid}/fill_appearance` | `persona_fill_appearance()` | `app.py:2360` |
...
| POST | `/api/providers` | `add_provider()` | `app.py:2123` |
| DELETE | `/api/providers/{pid}` | `del_provider()` | `app.py:2202` |
| PUT | `/api/providers/{pid}` | `put_provider()` | `app.py:2130` |
| GET | `/api/providers/{pid}/image_models` | `image_models()` | `app.py:2214` |
| GET | `/api/providers/{pid}/models` | `models()` | `app.py:2207` |
| PUT | `/api/providers/{pid}/prompt_cache` | `put_provider_prompt_cache()` | `app.py:2157` |
| PUT | `/api/reasoning_effort` | `put_reasoning_effort()` | `app.py:1440` |
| POST | `/api/steps/{sid}/activate` | `step_activate()` | `app.py:5264` |
| POST | `/api/steps/{sid}/edit` | `step_edit()` | `app.py:5254` |
| POST | `/api/steps/{sid}/reroll` | `step_reroll()` | `app.py:5207` |
| DELETE | `/api/turns/{tid}` | `turn_del()` | `app.py:5277` |
| GET | `/api/turns/{tid}/ambience` | `turn_ambience()` | `app.py:5536` |
| POST | `/api/turns/{tid}/ambience` | `turn_ambience_resolve()` | `app.py:5553` |
| GET | `/api/turns/{tid}/backdrop` | `turn_backdrop()` | `app.py:5358` |
| POST | `/api/turns/{tid}/backdrop` | `turn_backdrop_generate()` | `app.py:5406` |
| POST | `/api/turns/{tid}/branch` | `turn_branch()` | `app.py:4555` |
| PUT | `/api/turns/{tid}/input` | `edit_input()` | `app.py:4957` |
| GET | `/api/turns/{tid}/narration` | `turn_narration_variants()` | `app.py:5024` |
| POST | `/api/turns/{tid}/narration` | `turn_narration_select()` | `app.py:5045` |
| GET | `/api/turns/{tid}/pipeline` | `pipeline_get()` | `app.py:5069` |
| PUT | `/api/turns/{tid}/prose` | `edit_prose()` | `app.py:4972` |
| POST | `/api/turns/{tid}/reroll` | `turn_reroll()` | `app.py:5138` |
| POST | `/api/turns/{tid}/rerun` | `turn_rerun()` | `app.py:5148` |
| POST | `/api/turns/{tid}/resume` | `turn_resume()` | `app.py:5175` |
| GET | `/api/ui` | `ui_catalog_get()` | `app.py:2764` |
| PUT | `/api/ui-language` | `ui_language_put()` | `app.py:2786` |
| GET | `/api/updates/check` | `updates_check()` | `app.py:1805` |
| POST | `/api/updates/install` | `updates_install()` | `app.py:1809` |
...
### `static/js/settings.js` (3522 lines)

Sections: Chat tool modals (`:1`); Condition tab (`:642`); Survival tracker (`:702`); Character relocation (`:1014`); API connections (`:1705`); Software updates (host-only; git fast-forward from GitHub origin) (`:2821`); Legacy checkpoint conversion (host-only maintenance) (`:2853`); Prompts (`:3087`); and be able to load that pack's own sheets to edit, rather than (`:3098`); Extensions (`:3265`).
