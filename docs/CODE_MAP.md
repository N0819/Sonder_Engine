...
| `agents/character.py` | 4066 | Private character decision agent. | `agents.common`, `core.db`, `core.frames`, `llm.prompts`, `llm.schemas`, `mind`, `mind.affect`, `mind.memory`, `mind.memory_judge`, `mind.psychology_runtime`, `mind.theory_of_mind`, `story.character_schema`, `story.scene`, `world.gaps`, `world.place_purpose`, `world.spatial`, `world.survival` |
...
| Function | Start | Size |
|---|---:|---:|
| `character_step()` | 2940 | 1127 lines |
| `_annotate_known_exits()` | 2291 | 458 lines |
| `_ground_observation_citations()` | 1292 | 302 lines |
| `_unanswered_question_note()` | 505 | 213 lines |
| `_destination_from_goals()` | 1857 | 109 lines |
| `sprint_offers()` | 2784 | 97 lines |
| `_recent_self_moves()` | 232 | 90 lines |
| `strip_beat_reissues()` | 919 | 82 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `observations_from_render()` | 3100 | 209 lines |
| `_render_view_english()` | 2599 | 153 lines |
| `pose_percepts()` | 1226 | 144 lines |
| `_pose_referent()` | 927 | 91 lines |
| `presence_percepts()` | 726 | 89 lines |
| `_render_episode_english()` | 2901 | 84 lines |
| `_render_standing()` | 2460 | 79 lines |
| `_pose_owner_second_person()` | 1079 | 75 lines |

### `agents/director.py`

| Function | Start | Size |
|---|---:|---:|
| `director_resolve()` | 2503 | 1639 lines |
| `director_interpret()` | 449 | 621 lines |
| `_reconcile_resolution()` | 1446 | 522 lines |
| `_run_specialists()` | 2150 | 245 lines |
| `director_establish()` | 306 | 141 lines |
| `_reconcile_interpretation()` | 1072 | 139 lines |
| `_specialist_repairs()` | 1273 | 119 lines |
| `_prose_gate_facts()` | 2032 | 92 lines |
