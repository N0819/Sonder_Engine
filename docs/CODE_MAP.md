...
| `core/__init__.py` | 6 |  | — |
| `core/db.py` | 2042 | SQLite schema, migrations, connection management, transactions, and key/value world access. | `core.paths` |
...
| `web/__init__.py` | 6 |  | — |
| `web/app.py` | 6276 | FastAPI application assembly, resource CRUD, turn control, and streaming endpoints. | `agents`, `core`, `core.db`, `core.frames`, `core.paths`, `dressing.ambience`, `dressing.backdrops`, `llm`, `llm.prompts`, `llm.providers`, `mind.memory`, `persist.chat_archive`, `persist.checkpoints`, `persist.commit`, `story`, `story.character_schema`, `story.dialogue_colors`, `story.importers`, `story.scene`, `web`, `web.auth_routes`, `world`, `world.survival` |
...
| `init()` | 1886 | 113 lines |
| `conn()` | 1668 | 48 lines |
| `transaction()` | 1718 | 36 lines |
| `close_all_connections()` | 1638 | 22 lines |
| `_column_addition_already_applied()` | 1835 | 18 lines |
| `_backfill_resource_uids()` | 1868 | 17 lines |
| `qi()` | 1776 | 16 lines |
| `data_version()` | 1755 | 14 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `turn_branch()` | 5093 | 406 lines |
| `chat_get()` | 3370 | 234 lines |
| `_remap_cp_blob()` | 1055 | 211 lines |
| `bootstrap()` | 1386 | 104 lines |
| `_stream()` | 701 | 91 lines |
| `dlg_put()` | 4492 | 79 lines |
| `_ambience_payload()` | 6051 | 75 lines |
| `lore_entry_edit()` | 3026 | 70 lines |
...
|---|---|---|---|
| GET | `/` | `index()` | `web/app.py:556` |
| PUT | `/api/active_preset` | `set_active()` | `web/app.py:1802` |
| PUT | `/api/affect_habituation` | `set_affect_habituation()` | `web/app.py:2122` |
| PUT | `/api/agent_models` | `put_agent_models()` | `web/app.py:1492` |
| PUT | `/api/ambience` | `put_ambience()` | `web/app.py:1613` |
| GET | `/api/ambience/library` | `ambience_library()` | `web/app.py:6216` |
| GET | `/api/ambience/search` | `ambience_search()` | `web/app.py:6195` |
| PUT | `/api/attire_beneath` | `set_attire_beneath()` | `web/app.py:2141` |
...
| GET | `/api/auto_promote` | `get_auto_promote()` | `web/app.py:3702` |
| PUT | `/api/auto_promote` | `set_auto_promote()` | `web/app.py:3715` |
| PUT | `/api/backdrops` | `put_backdrops()` | `web/app.py:1603` |
| GET | `/api/bootstrap` | `bootstrap()` | `web/app.py:1386` |
| POST | `/api/characters` | `char_create()` | `web/app.py:2597` |
| POST | `/api/characters/generate` | `char_generate()` | `web/app.py:2574` |
| POST | `/api/characters/import` | `char_import()` | `web/app.py:2622` |
| DELETE | `/api/characters/{cid}` | `char_del()` | `web/app.py:2748` |
| PUT | `/api/characters/{cid}` | `char_edit()` | `web/app.py:2738` |
| GET | `/api/characters/{cid}/export` | `char_export()` | `web/app.py:2730` |
| POST | `/api/characters/{cid}/fill_appearance` | `char_fill_appearance()` | `web/app.py:2718` |
| POST | `/api/characters/{cid}/fill_psychology` | `char_fill_psychology()` | `web/app.py:2689` |
| POST | `/api/characters/{cid}/generate_greeting` | `char_generate_greeting()` | `web/app.py:2673` |
| POST | `/api/characters/{cid}/recover_greetings` | `char_recover_greetings()` | `web/app.py:2663` |
| POST | `/api/characters/{cid}/start` | `character_start_story()` | `web/app.py:2637` |
| POST | `/api/chats` | `chat_new()` | `web/app.py:3105` |
| POST | `/api/chats/import` | `import_chat()` | `persist/chat_archive.py:257` |
| DELETE | `/api/chats/{cid}` | `chat_del()` | `web/app.py:3340` |
| GET | `/api/chats/{cid}` | `chat_get()` | `web/app.py:3370` |
| PUT | `/api/chats/{cid}` | `chat_edit()` | `web/app.py:3203` |
| POST | `/api/chats/{cid}/abort` | `chat_abort()` | `web/app.py:5089` |
| GET | `/api/chats/{cid}/ambience/oneshot/{name}` | `ambience_oneshot()` | `web/app.py:6225` |
| DELETE | `/api/chats/{cid}/ambience/pin` | `ambience_pin_delete()` | `web/app.py:6273` |
| PUT | `/api/chats/{cid}/ambience/pin` | `ambience_pin_put()` | `web/app.py:6254` |
| GET | `/api/chats/{cid}/ambience/pins` | `ambience_pins_get()` | `web/app.py:6249` |
| GET | `/api/chats/{cid}/ambience/{signature}.audio` | `ambience_audio()` | `web/app.py:6179` |
| GET | `/api/chats/{cid}/attire` | `attire_get()` | `web/app.py:4425` |
| PUT | `/api/chats/{cid}/attire` | `attire_put()` | `web/app.py:4436` |
| GET | `/api/chats/{cid}/backdrop/{signature}.png` | `backdrop_image()` | `web/app.py:6019` |
| GET | `/api/chats/{cid}/background_config` | `bg_cfg_get()` | `web/app.py:4608` |
| PUT | `/api/chats/{cid}/background_config` | `bg_cfg_put()` | `web/app.py:4612` |
| POST | `/api/chats/{cid}/characters` | `chat_add_char()` | `web/app.py:3606` |
| DELETE | `/api/chats/{cid}/characters/{ch}` | `chat_del_char()` | `web/app.py:3994` |
| PUT | `/api/chats/{cid}/characters/{ch}/card` | `chat_char_card_put()` | `web/app.py:4004` |
| PUT | `/api/chats/{cid}/characters/{ch}/dialogue_color` | `dialogue_color_put()` | `web/app.py:4309` |
| GET | `/api/chats/{cid}/characters/{ch}/memories` | `mem_list()` | `web/app.py:4829` |
| POST | `/api/chats/{cid}/characters/{ch}/memories` | `mem_add()` | `web/app.py:4976` |
| POST | `/api/chats/{cid}/characters/{ch}/memories/backfill` | `mem_backfill()` | `web/app.py:4946` |
| POST | `/api/chats/{cid}/characters/{ch}/memories/consolidate` | `mem_consolidate()` | `web/app.py:4931` |
| GET | `/api/chats/{cid}/characters/{ch}/memories/coverage` | `mem_coverage()` | `web/app.py:4967` |
| GET | `/api/chats/{cid}/characters/{ch}/memories/export` | `mem_export()` | `web/app.py:4875` |
| POST | `/api/chats/{cid}/characters/{ch}/memories/import` | `mem_import()` | `web/app.py:4886` |
| GET | `/api/chats/{cid}/characters/{ch}/memories/search` | `mem_search()` | `web/app.py:4850` |
| GET | `/api/chats/{cid}/characters/{ch}/memory-context` | `memory_context_preview()` | `web/app.py:4907` |
| PUT | `/api/chats/{cid}/characters/{ch}/position` | `chat_char_position_put()` | `web/app.py:4221` |
| GET | `/api/chats/{cid}/characters/{ch}/private_history` | `ph_get()` | `web/app.py:4290` |
| PUT | `/api/chats/{cid}/characters/{ch}/private_history` | `ph_put()` | `web/app.py:4300` |
| GET | `/api/chats/{cid}/characters/{ch}/relationships` | `relationships_get()` | `web/app.py:4920` |
| GET | `/api/chats/{cid}/dialogue_config` | `dlg_get()` | `web/app.py:4475` |
| PUT | `/api/chats/{cid}/dialogue_config` | `dlg_put()` | `web/app.py:4492` |
| GET | `/api/chats/{cid}/dramatic_irony` | `get_dramatic_irony_feed()` | `web/app.py:3660` |
| GET | `/api/chats/{cid}/export` | `export_chat()` | `persist/chat_archive.py:251` |
| GET | `/api/chats/{cid}/fixed_points` | `fixed_points_list()` | `web/app.py:4775` |
| POST | `/api/chats/{cid}/fixed_points` | `fixed_points_create()` | `web/app.py:4785` |
| DELETE | `/api/chats/{cid}/fixed_points/{anchor_id}` | `fixed_points_delete()` | `web/app.py:4807` |
| GET | `/api/chats/{cid}/frames` | `frames_list()` | `web/app.py:4729` |
| POST | `/api/chats/{cid}/frames` | `frames_create()` | `web/app.py:4733` |
| GET | `/api/chats/{cid}/guest_invites` | `list_guest_invites()` | `web/app.py:3875` |
| POST | `/api/chats/{cid}/guest_invites` | `create_guest_invite()` | `web/app.py:3855` |
| DELETE | `/api/chats/{cid}/guest_invites/{gid}` | `revoke_guest_invite()` | `web/app.py:3879` |
| GET | `/api/chats/{cid}/language` | `chat_language_get()` | `web/app.py:3170` |
| PUT | `/api/chats/{cid}/language` | `chat_language_put()` | `web/app.py:3187` |
| GET | `/api/chats/{cid}/living_world` | `living_world_get()` | `web/app.py:4573` |
| PUT | `/api/chats/{cid}/living_world` | `living_world_put()` | `web/app.py:4596` |
| DELETE | `/api/chats/{cid}/lorebook` | `detach_lore()` | `web/app.py:3331` |
| POST | `/api/chats/{cid}/lorebook` | `bind_lore()` | `web/app.py:3310` |
| GET | `/api/chats/{cid}/lorebooks` | `chat_lorebooks_owned()` | `web/app.py:2225` |
| POST | `/api/chats/{cid}/lorebooks` | `attach_lore()` | `web/app.py:3234` |
| DELETE | `/api/chats/{cid}/lorebooks/{lid}` | `detach_book()` | `web/app.py:3295` |
| PUT | `/api/chats/{cid}/lorebooks/{lid}` | `set_book_enabled()` | `web/app.py:3259` |
| GET | `/api/chats/{cid}/paradox_policy` | `paradox_policy_get()` | `web/app.py:4760` |
| PUT | `/api/chats/{cid}/paradox_policy` | `paradox_policy_put()` | `web/app.py:4764` |
| GET | `/api/chats/{cid}/persona_private_history` | `pph_get()` | `web/app.py:4361` |
| PUT | `/api/chats/{cid}/persona_private_history` | `pph_put()` | `web/app.py:4374` |
| GET | `/api/chats/{cid}/personas` | `chat_list_extra_personas()` | `web/app.py:3720` |
| POST | `/api/chats/{cid}/personas` | `chat_add_persona()` | `web/app.py:3765` |
| DELETE | `/api/chats/{cid}/personas/{pid}` | `chat_del_persona()` | `web/app.py:3791` |
| PUT | `/api/chats/{cid}/personas/{pid}/station` | `chat_persona_station()` | `web/app.py:3730` |
| GET | `/api/chats/{cid}/player_authority` | `player_authority_get()` | `web/app.py:4692` |
| PUT | `/api/chats/{cid}/player_authority` | `player_authority_put()` | `web/app.py:4707` |
| GET | `/api/chats/{cid}/player_view` | `player_view_get()` | `web/app.py:4669` |
| GET | `/api/chats/{cid}/positions` | `chat_positions_get()` | `web/app.py:4154` |
| GET | `/api/chats/{cid}/promises` | `get_promise_ledger()` | `web/app.py:3664` |
| GET | `/api/chats/{cid}/promotable` | `list_promotable_presences()` | `web/app.py:3656` |
| POST | `/api/chats/{cid}/promotions/confirm` | `confirm_promotion()` | `web/app.py:3682` |
| POST | `/api/chats/{cid}/promotions/draft` | `draft_promotion()` | `web/app.py:3668` |
| GET | `/api/chats/{cid}/story_view` | `story_view_get()` | `web/app.py:4638` |
| GET | `/api/chats/{cid}/style_guide` | `style_guide_get()` | `web/app.py:4458` |
| PUT | `/api/chats/{cid}/style_guide` | `style_guide_put()` | `web/app.py:4464` |
| GET | `/api/chats/{cid}/survival` | `survival_get()` | `web/app.py:4062` |
| PUT | `/api/chats/{cid}/survival` | `survival_put()` | `web/app.py:4067` |
| POST | `/api/chats/{cid}/turns` | `turn_new()` | `web/app.py:5029` |
| POST | `/api/chats/{cid}/turns/{idx}/player_input` | `submit_extra_player_input()` | `web/app.py:3805` |
| GET | `/api/chats/{cid}/viewers` | `viewers_get()` | `web/app.py:4684` |
| GET | `/api/chats/{cid}/vitals` | `chat_vitals_get()` | `web/app.py:4119` |
| GET | `/api/chats/{cid}/world` | `world_get()` | `web/app.py:4379` |
| PUT | `/api/chats/{cid}/world` | `world_put()` | `web/app.py:4389` |
| GET | `/api/default_prompts` | `default_prompts()` | `web/app.py:1732` |
| PUT | `/api/director_fanout_mode` | `set_director_fanout_mode()` | `web/app.py:2098` |
| PUT | `/api/exemplars` | `put_exemplars()` | `web/app.py:1572` |
| GET | `/api/extensions` | `extensions_list()` | `web/app.py:1819` |
| POST | `/api/extensions/install` | `extension_install()` | `web/app.py:1841` |
| GET | `/api/extensions/ui.css` | `extensions_ui_css()` | `web/app.py:2019` |
| GET | `/api/extensions/ui.js` | `extensions_ui()` | `web/app.py:2010` |
| GET | `/api/extensions/updates` | `extension_updates()` | `web/app.py:1862` |
| DELETE | `/api/extensions/{eid}` | `extension_remove()` | `web/app.py:1883` |
| GET | `/api/extensions/{eid}/asset/{path:path}` | `extension_asset()` | `web/app.py:2074` |
| POST | `/api/extensions/{eid}/disable` | `extension_disable()` | `web/app.py:1891` |
| DELETE | `/api/extensions/{eid}/document` | `extension_document_delete()` | `web/app.py:1987` |
| GET | `/api/extensions/{eid}/document` | `extension_document_get()` | `web/app.py:1955` |
| PUT | `/api/extensions/{eid}/document` | `extension_document_put()` | `web/app.py:1967` |
| DELETE | `/api/extensions/{eid}/documents` | `extension_documents_delete()` | `web/app.py:1997` |
| GET | `/api/extensions/{eid}/documents` | `extension_documents_list()` | `web/app.py:1934` |
| GET | `/api/extensions/{eid}/documents/verify` | `extension_documents_verify()` | `web/app.py:1945` |
| POST | `/api/extensions/{eid}/enable` | `extension_enable()` | `web/app.py:1833` |
| GET | `/api/extensions/{eid}/state` | `extension_state()` | `web/app.py:1896` |
| GET | `/api/extensions/{eid}/ui.css` | `extension_ui_css_one()` | `web/app.py:2041` |
| GET | `/api/extensions/{eid}/ui.js` | `extension_ui_one()` | `web/app.py:2029` |
| POST | `/api/extensions/{eid}/update` | `extension_update()` | `web/app.py:1873` |
| POST | `/api/guest/input` | `guest_input()` | `web/app.py:3969` |
| GET | `/api/guest/state` | `guest_state()` | `web/app.py:3901` |
| PUT | `/api/image_model` | `put_image_model()` | `web/app.py:1550` |
| POST | `/api/join` | `join_with_code()` | `web/app.py:3885` |
| GET | `/api/language-packs` | `language_packs_get()` | `web/app.py:3123` |
| GET | `/api/language-packs/{language_id}/ui` | `language_pack_ui()` | `web/app.py:3144` |
| DELETE | `/api/lore_entries/{eid}` | `lore_entry_delete()` | `web/app.py:3098` |
| PUT | `/api/lore_entries/{eid}` | `lore_entry_edit()` | `web/app.py:3026` |
| DELETE | `/api/lore_gen_jobs/{job_id}` | `lorebook_generate_discard()` | `web/app.py:2381` |
| POST | `/api/lore_gen_jobs/{job_id}/resume` | `lorebook_generate_resume()` | `web/app.py:2363` |
| DELETE | `/api/lorebook_links/{link_id}` | `lorebook_link_delete()` | `web/app.py:2321` |
| PUT | `/api/lorebook_links/{link_id}` | `lorebook_link_update()` | `web/app.py:2307` |
| POST | `/api/lorebooks` | `lore_create()` | `web/app.py:2855` |
| POST | `/api/lorebooks/import` | `lore_import()` | `web/app.py:2417` |
| DELETE | `/api/lorebooks/{lid}` | `lore_delete()` | `web/app.py:2947` |
| GET | `/api/lorebooks/{lid}` | `lore_get()` | `web/app.py:2835` |
| PUT | `/api/lorebooks/{lid}` | `lore_edit()` | `web/app.py:2877` |
| POST | `/api/lorebooks/{lid}/apply_plan` | `lorebook_apply_plan()` | `web/app.py:2390` |
| POST | `/api/lorebooks/{lid}/entries` | `lore_entry_create()` | `web/app.py:2997` |
| GET | `/api/lorebooks/{lid}/export` | `lore_export()` | `web/app.py:2953` |
| POST | `/api/lorebooks/{lid}/generate` | `lore_generate()` | `web/app.py:2983` |
| GET | `/api/lorebooks/{lid}/generate_job` | `lorebook_generate_job()` | `web/app.py:2352` |
| POST | `/api/lorebooks/{lid}/generate_plan` | `lorebook_generate_plan()` | `web/app.py:2326` |
| GET | `/api/lorebooks/{lid}/links` | `lorebook_links_get()` | `web/app.py:2280` |
| POST | `/api/lorebooks/{lid}/links` | `lorebook_link_create()` | `web/app.py:2285` |
| POST | `/api/lorebooks/{lid}/move` | `lorebook_move()` | `web/app.py:2207` |
| POST | `/api/lorebooks/{lid}/reinterpret` | `lore_reinterpret_route()` | `web/app.py:2970` |
| POST | `/api/lorebooks/{lid}/reorder` | `lorebook_reorder()` | `web/app.py:2216` |
| GET | `/api/maintenance/checkpoints` | `maintenance_checkpoints()` | `web/app.py:2164` |
| POST | `/api/maintenance/checkpoints/compact` | `maintenance_compact()` | `web/app.py:2180` |
| PUT | `/api/max_output_tokens` | `put_max_output_tokens()` | `web/app.py:1699` |
| DELETE | `/api/memories/{mid}` | `mem_del()` | `web/app.py:5023` |
| PUT | `/api/memories/{mid}` | `mem_edit()` | `web/app.py:5002` |
| GET | `/api/memory/embeddings` | `memory_embeddings_status()` | `web/app.py:1523` |
| POST | `/api/memory/embeddings/rebuild` | `memory_embeddings_rebuild()` | `web/app.py:1538` |
| GET | `/api/nsfw` | `get_nsfw()` | `web/app.py:2089` |
| PUT | `/api/nsfw` | `set_nsfw()` | `web/app.py:2093` |
...
| POST | `/api/personas` | `persona_create()` | `web/app.py:2777` |
| POST | `/api/personas/generate` | `persona_generate()` | `web/app.py:2755` |
| POST | `/api/personas/import` | `persona_import()` | `web/app.py:2797` |
| DELETE | `/api/personas/{pid}` | `persona_del()` | `web/app.py:2829` |
| PUT | `/api/personas/{pid}` | `persona_edit()` | `web/app.py:2820` |
| GET | `/api/personas/{pid}/export` | `persona_export()` | `web/app.py:2811` |
| POST | `/api/personas/{pid}/fill_appearance` | `persona_fill_appearance()` | `web/app.py:2725` |
| PUT | `/api/prompt_presets` | `save_preset()` | `web/app.py:1743` |
| POST | `/api/prompt_presets/import` | `import_preset()` | `web/app.py:1779` |
| DELETE | `/api/prompt_presets/{name}` | `del_preset()` | `web/app.py:1793` |
| GET | `/api/prompt_presets/{name}/export` | `export_preset()` | `web/app.py:1770` |
| POST | `/api/providers` | `add_provider()` | `web/app.py:2473` |
| DELETE | `/api/providers/{pid}` | `del_provider()` | `web/app.py:2552` |
| PUT | `/api/providers/{pid}` | `put_provider()` | `web/app.py:2480` |
| GET | `/api/providers/{pid}/image_models` | `image_models()` | `web/app.py:2564` |
| GET | `/api/providers/{pid}/models` | `models()` | `web/app.py:2557` |
| PUT | `/api/providers/{pid}/prompt_cache` | `put_provider_prompt_cache()` | `web/app.py:2507` |
| PUT | `/api/reasoning_effort` | `put_reasoning_effort()` | `web/app.py:1669` |
| POST | `/api/steps/{sid}/activate` | `step_activate()` | `web/app.py:5826` |
| POST | `/api/steps/{sid}/edit` | `step_edit()` | `web/app.py:5816` |
| POST | `/api/steps/{sid}/reroll` | `step_reroll()` | `web/app.py:5769` |
| DELETE | `/api/turns/{tid}` | `turn_del()` | `web/app.py:5839` |
| GET | `/api/turns/{tid}/ambience` | `turn_ambience()` | `web/app.py:6129` |
| POST | `/api/turns/{tid}/ambience` | `turn_ambience_resolve()` | `web/app.py:6146` |
| GET | `/api/turns/{tid}/backdrop` | `turn_backdrop()` | `web/app.py:5976` |
| POST | `/api/turns/{tid}/backdrop` | `turn_backdrop_generate()` | `web/app.py:5991` |
| POST | `/api/turns/{tid}/branch` | `turn_branch()` | `web/app.py:5093` |
| PUT | `/api/turns/{tid}/input` | `edit_input()` | `web/app.py:5501` |
| GET | `/api/turns/{tid}/narration` | `turn_narration_variants()` | `web/app.py:5586` |
| POST | `/api/turns/{tid}/narration` | `turn_narration_select()` | `web/app.py:5607` |
| GET | `/api/turns/{tid}/pipeline` | `pipeline_get()` | `web/app.py:5631` |
| PUT | `/api/turns/{tid}/prose` | `edit_prose()` | `web/app.py:5516` |
| POST | `/api/turns/{tid}/reroll` | `turn_reroll()` | `web/app.py:5700` |
| POST | `/api/turns/{tid}/rerun` | `turn_rerun()` | `web/app.py:5710` |
| POST | `/api/turns/{tid}/resume` | `turn_resume()` | `web/app.py:5737` |
| GET | `/api/ui` | `ui_catalog_get()` | `web/app.py:3134` |
| PUT | `/api/ui-language` | `ui_language_put()` | `web/app.py:3159` |
| GET | `/api/updates/check` | `updates_check()` | `web/app.py:2156` |
| POST | `/api/updates/install` | `updates_install()` | `web/app.py:2160` |
| GET | `/guest` | `guest_page()` | `web/app.py:548` |
| GET | `/login` | `login_page()` | `web/app.py:582` |
| GET | `/ui-next` | `ui_next()` | `web/app.py:561` |
| GET | `/ui-next/lab` | `ui_next_lab()` | `web/app.py:575` |
