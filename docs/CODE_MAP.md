...
| `agents/common.py` | 1937 | Shared normalization, lore, delivery, and perception helpers. | `character_schema`, `db`, `llm_quality`, `memory`, `providers`, `scene`, `schemas`, `spatial`, `theory_of_mind` |
...
| `agents/perception.py` | 1234 | Opening, action-onset, and outcome observer views. | `affect`, `agents.common`, `character_schema`, `db`, `prompts`, `scene`, `spatial` |
...
| `prompts.py` | 1861 | Default system prompts and prompt preset access. | `db` |
...
| `_scrub_undeclared_player_speech()` | 1609 | 77 lines |
| `_check_narrator_fidelity()` | 1809 | 65 lines |
| `_scrub_unknown_identities()` | 1004 | 57 lines |
| `_strip_player_echo()` | 1505 | 56 lines |
| `_assert_plan_materialized()` | 138 | 55 lines |
| `_dedupe_view_sentences()` | 1694 | 43 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `perception_outcome()` | 759 | 476 lines |
| `perception_act()` | 497 | 261 lines |
| `perception_establish()` | 348 | 148 lines |
| `_delivered_manifest()` | 198 | 47 lines |
| `_subject_disguise_context()` | 247 | 38 lines |
| `_observer_facing_sequence()` | 314 | 32 lines |
| `_disguise_leak_check()` | 287 | 25 lines |
| `_ambient_location_for()` | 89 | 20 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `get_prompt()` | 1852 | 10 lines |
| `presets()` | 1843 | 2 lines |
| `active_preset()` | 1846 | 2 lines |
| `nsfw_enabled()` | 1849 | 2 lines |
