...
| `agents/character.py` | 1032 | Private character decision agent. | `affect`, `agents.common`, `character_schema`, `db`, `frames`, `memory`, `prompts`, `psychology_runtime`, `scene`, `schemas`, `spatial`, `survival`, `theory_of_mind` |
...
| `commit.py` | 4429 | Validated persistence of scene, entities, cast, lore, relationships, events, and memories. | `affect`, `character_schema`, `db`, `frames`, `mechanics`, `memory`, `paradox`, `prompts`, `providers`, `psychology_runtime`, `scene`, `spatial`, `spatial_frames`, `survival`, `theory_of_mind` |
...
| `prompts.py` | 2835 | Default system prompts and prompt preset access. | `db` |
...
| `spatial.py` | 3758 | Deterministic room, barrier, hearing, visibility, placement, and scene-diff logic. | `schemas`, `spatial_orientation` |
...
| Function | Start | Size |
|---|---:|---:|
| `character_step()` | 649 | 384 lines |
| `_annotate_known_exits()` | 309 | 338 lines |
| `_verdict()` | 206 | 52 lines |
| `_recent_self_lines()` | 80 | 36 lines |
| `_frontier_hops()` | 273 | 34 lines |
| `_known_pronouns()` | 118 | 33 lines |
| `_merge_standing_intentions()` | 63 | 15 lines |
| `_appeal()` | 260 | 11 lines |
...
| `character_standing_intentions()` | 1050 | 31 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `prepare_memory_commit()` | 3471 | 619 lines |
| `prepare_scene_commit()` | 1400 | 242 lines |
| `track_background_presences()` | 2158 | 196 lines |
| `commit_world_entities()` | 1774 | 163 lines |
| `_prepare_destruction()` | 691 | 158 lines |
| `update_place_graph()` | 66 | 153 lines |
| `prepare_mapping_commit()` | 2873 | 133 lines |
| `commit_mapping()` | 3008 | 120 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `get_prompt()` | 2826 | 10 lines |
| `presets()` | 2817 | 2 lines |
| `active_preset()` | 2820 | 2 lines |
| `nsfw_enabled()` | 2823 | 2 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `merge_scene_with_diff()` | 3488 | 226 lines |
| `apply_transit_dock_edges()` | 3152 | 165 lines |
| `visible_adjacent_rooms()` | 2712 | 117 lines |
| `contacts_from_entity_state()` | 1944 | 106 lines |
| `hear_level()` | 750 | 100 lines |
| `sprint_reach()` | 2555 | 87 lines |
