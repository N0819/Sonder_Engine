...
| Function | Start | Size |
|---|---:|---:|
| `grant_mandate()` | 136 | 73 lines |
| `coverage()` | 232 | 16 lines |
| `_most_permissive()` | 276 | 15 lines |
| `expire_mandates()` | 211 | 14 lines |
| `fill_limit()` | 261 | 13 lines |
| `surprise_dial()` | 320 | 13 lines |
| `spend_limits()` | 293 | 12 lines |
| `beats_per_proposal()` | 335 | 12 lines |
