...
| `agents/director_prose.py` | 1137 |  | `agents.director_fanout`, `agents.director_scopes`, `core.db`, `llm`, `llm.prompts` |
...
| `run()` | 934 | 131 lines |
| `encode()` | 741 | 80 lines |
| `ledger_from_events()` | 862 | 70 lines |
| `dispatch()` | 1067 | 56 lines |
