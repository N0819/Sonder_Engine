...
| `agents/character.py` | 1646 | Private character decision agent. | `affect`, `agents.common`, `character_schema`, `db`, `frames`, `memory`, `prompts`, `psychology_runtime`, `scene`, `schemas`, `spatial`, `survival`, `theory_of_mind` |
...
| `commit.py` | 4479 | Validated persistence of scene, entities, cast, lore, relationships, events, and memories. | `affect`, `character_schema`, `db`, `frames`, `mechanics`, `memory`, `paradox`, `prompts`, `providers`, `psychology_runtime`, `scene`, `spatial`, `spatial_frames`, `survival`, `theory_of_mind` |
...
| `prompts.py` | 2969 | Default system prompts and prompt preset access. | `db` |
...
| `spatial.py` | 3822 | Deterministic room, barrier, hearing, visibility, placement, and scene-diff logic. | `schemas`, `spatial_orientation` |
...
| `apply_intent_ops()` | 857 | 126 lines |
| `apply_project_ops()` | 1025 | 100 lines |
| `appraise()` | 384 | 79 lines |
| `validate_drive_shift()` | 1285 | 79 lines |
| `update_drive_strain()` | 1166 | 77 lines |
| `normalize_wants()` | 684 | 73 lines |
| `ground_tells()` | 1438 | 65 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `_annotate_known_exits()` | 654 | 445 lines |
| `character_step()` | 1230 | 417 lines |
| `sprint_offers()` | 1134 | 94 lines |
| `_destination_from_goals()` | 373 | 86 lines |
| `_verdict()` | 217 | 72 lines |
| `_en_route()` | 586 | 66 lines |
| `_recent_self_lines()` | 82 | 36 lines |
| `_frontier_hops()` | 304 | 34 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `director_resolve()` | 2209 | 754 lines |
| `director_interpret()` | 302 | 320 lines |
| `_reconcile_resolution()` | 1857 | 268 lines |
| `_reconcile_interpretation()` | 770 | 119 lines |
| `director_establish()` | 156 | 95 lines |
| `_evidence_present()` | 1629 | 89 lines |
| `_narrated_destruction_subjects()` | 1245 | 79 lines |
| `_untracked_unconsciousness_subjects()` | 1139 | 51 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `normalize_character_data()` | 706 | 155 lines |
| `default_character_data()` | 293 | 88 lines |
| `_normalize_psychology()` | 164 | 78 lines |
| `repair_character_shape()` | 647 | 57 lines |
| `character_initial_active_state()` | 1001 | 48 lines |
| `normalize_persona_data()` | 862 | 47 lines |
| `_coerce_appearance()` | 568 | 45 lines |
| `character_projects()` | 1082 | 35 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `prepare_memory_commit()` | 3472 | 668 lines |
| `prepare_scene_commit()` | 1401 | 242 lines |
| `track_background_presences()` | 2159 | 196 lines |
| `commit_world_entities()` | 1775 | 163 lines |
| `_prepare_destruction()` | 692 | 158 lines |
| `update_place_graph()` | 67 | 153 lines |
| `prepare_mapping_commit()` | 2874 | 133 lines |
| `commit_mapping()` | 3009 | 120 lines |
...
| `consolidate_character_memory()` | 1428 | 93 lines |
| `restore_lorebook()` | 1835 | 79 lines |
| `monitoring_subtree()` | 571 | 78 lines |
| `resolve_lorebook_graph()` | 383 | 76 lines |
| `lorebook_manifest()` | 505 | 65 lines |
| `reconcile_inference_confidence()` | 2258 | 64 lines |
| `build_character_memory_context()` | 1366 | 61 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `get_prompt()` | 2960 | 10 lines |
| `presets()` | 2951 | 2 lines |
| `active_preset()` | 2954 | 2 lines |
| `nsfw_enabled()` | 2957 | 2 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `preprocess_llm_output()` | 1819 | 226 lines |
| `semantic_output_errors()` | 2340 | 111 lines |
| `validate_llm_output_strict()` | 2452 | 53 lines |
| `_coerce_conditions()` | 1637 | 37 lines |
| `_coerce_str_list()` | 14 | 33 lines |
| `_coerce_considered_responses()` | 1574 | 32 lines |
| `validate_llm_output()` | 2046 | 29 lines |
| `_coerce_candidate_response()` | 1252 | 28 lines |

### `spatial.py`

| Function | Start | Size |
|---|---:|---:|
| `merge_scene_with_diff()` | 3552 | 226 lines |
| `apply_transit_dock_edges()` | 3216 | 165 lines |
| `sprint_reach()` | 2555 | 151 lines |
| `visible_adjacent_rooms()` | 2776 | 117 lines |
...
| GET | `/api/chats/{cid}/backdrop/{signature}.png` | `backdrop_image()` | `app.py:3871` |
...
| POST | `/api/steps/{sid}/activate` | `step_activate()` | `app.py:3715` |
| POST | `/api/steps/{sid}/edit` | `step_edit()` | `app.py:3705` |
| POST | `/api/steps/{sid}/reroll` | `step_reroll()` | `app.py:3658` |
| DELETE | `/api/turns/{tid}` | `turn_del()` | `app.py:3728` |
| GET | `/api/turns/{tid}/backdrop` | `turn_backdrop()` | `app.py:3809` |
| POST | `/api/turns/{tid}/backdrop` | `turn_backdrop_generate()` | `app.py:3844` |
| POST | `/api/turns/{tid}/branch` | `turn_branch()` | `app.py:3116` |
| PUT | `/api/turns/{tid}/input` | `edit_input()` | `app.py:3505` |
| GET | `/api/turns/{tid}/pipeline` | `pipeline_get()` | `app.py:3551` |
| PUT | `/api/turns/{tid}/prose` | `edit_prose()` | `app.py:3520` |
| POST | `/api/turns/{tid}/reroll` | `turn_reroll()` | `app.py:3589` |
| POST | `/api/turns/{tid}/rerun` | `turn_rerun()` | `app.py:3599` |
| POST | `/api/turns/{tid}/resume` | `turn_resume()` | `app.py:3626` |
...
### `static/js/chat.js` (1776 lines)

Sections: Scene mood (`:1`); Pipeline drawer (`:627`); Relationship viewer (`:928`); Memory browser (`:1000`); Private history (`:1718`).
