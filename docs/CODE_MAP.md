...
| `agents/director.py` | 4935 | Scene establishment, player interpretation, and objective resolution. | `agents.common`, `agents.director_contact`, `agents.director_evidence`, `agents.director_fanout`, `agents.director_floors`, `agents.director_lingua`, `agents.director_movement`, `agents.director_reconcile`, `agents.director_scopes`, `agents.director_views`, `core.db`, `llm`, `llm.prompts`, `llm.providers`, `llm.schemas`, `mind.memory`, `story`, `story.attire`, `story.character_schema`, `story.scene`, `world.paradox`, `world.spatial`, `world.survival` |
...
| `world/spatial_senses.py` | 1465 |  | `world.spatial_barriers`, `world.spatial_contacts`, `world.spatial_containment`, `world.spatial_geometry`, `world.spatial_identity`, `world.spatial_light`, `world.spatial_orientation`, `world.spatial_routing` |
...
| Function | Start | Size |
|---|---:|---:|
| `director_resolve()` | 3002 | 1900 lines |
| `director_interpret()` | 759 | 651 lines |
| `_reconcile_resolution()` | 1786 | 522 lines |
| `_run_specialists()` | 2515 | 263 lines |
| `director_establish()` | 323 | 171 lines |
| `_reconcile_interpretation()` | 1412 | 139 lines |
| `_specialist_repairs()` | 1613 | 119 lines |
| `_ground_public_evidence()` | 2820 | 112 lines |
...
| Function | Start | Size |
|---|---:|---:|
| `_hear_level()` | 879 | 154 lines |
| `spatial_rel_between()` | 491 | 94 lines |
| `_opening_view_cap()` | 601 | 74 lines |
| `visual_level_between()` | 677 | 74 lines |
| `scent_level()` | 37 | 56 lines |
| `_clean_comms_channel()` | 158 | 53 lines |
| `comms_link()` | 297 | 49 lines |
| `hear_level()` | 824 | 45 lines |
