...
| `prompts.py` | 1887 | Default system prompts and prompt preset access. | `db` |
...
| Function | Start | Size |
|---|---:|---:|
| `get_prompt()` | 1878 | 10 lines |
| `presets()` | 1869 | 2 lines |
| `active_preset()` | 1872 | 2 lines |
| `nsfw_enabled()` | 1875 | 2 lines |
