      ...
      if (report?.update) {
        ...
        update.addEventListener("click", async () => {
          ...
          try {
            ...
            status.textContent = error?.userMessage || error?.message || `Sonder could not update ${actionName}.`;
          }
        });
      ...
      toggle.addEventListener("click", async () => {
        if (extension.enabled) {
          ...
          try {
            ...
            status.textContent = error?.userMessage || error?.message || `Sonder could not disable ${actionName}.`;
          }
          return;
        }
        ...
        confirm.addEventListener("click", async () => {
          ...
          try {
            ...
            status.textContent = error?.userMessage || error?.message || `Sonder could not enable ${actionName}.`;
          }
        });
        cancel.addEventListener("click", () => {
          consent.hidden = true;
      ...
      remove.addEventListener("click", () => {
        ...
        confirm.addEventListener("click", async () => {
          ...
          try {
            ...
            status.textContent = error?.userMessage || error?.message || `Sonder could not remove ${actionName}.`;
          }
        });
        cancel.addEventListener("click", () => {
          consent.hidden = true;
