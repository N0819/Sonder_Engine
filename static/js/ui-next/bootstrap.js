import { assertReleaseModules } from "./release.js?release=alpha98-ui1";
...
const SERVICE_PATHS = Object.freeze({
  api: "./api.js?release=alpha98-ui1",
  errors: "./errors.js?release=alpha98-ui1",
  store: "./store.js?release=alpha98-ui1",
  router: "./router.js?release=alpha98-ui1",
  localization: "./localization.js?release=alpha98-ui1",
  content: "./content.js?release=alpha98-ui1",
  tasks: "./tasks.js?release=alpha98-ui1",
  notices: "./notices.js?release=alpha98-ui1",
  diagnostics: "./diagnostics.js?release=alpha98-ui1",
  storage: "./storage.js?release=alpha98-ui1",
  credentials: "./credentials.js?release=alpha98-ui1",
  savePolicy: "./save-policy.js?release=alpha98-ui1",
  extensions: "./extensions.js?release=alpha98-ui1",
  extensionsV1: "./extensions-v1.js?release=alpha98-ui1",
  destinations: "./destinations.js?release=alpha98-ui1",
  settingsView: "./settings-view.js?release=alpha98-ui1",
  inspectorHost: "./inspector-host.js?release=alpha98-ui1",
  libraryRuntime: "./library-runtime.js?release=alpha98-ui1",
  libraryView: "./library-view.js?release=alpha98-ui1",
  libraryAuthoringRuntime: "./library-authoring-runtime.js?release=alpha98-ui1",
  libraryAuthoringView: "./library-authoring-view.js?release=alpha98-ui1",
  libraryStoryEditor: "./library-editors/story.js?release=alpha98-ui1",
  libraryPersonEditor: "./library-editors/character-persona.js?release=alpha98-ui1",
  navigationState: "./navigation-state.js?release=alpha98-ui1",
  shortcuts: "./shortcuts.js?release=alpha98-ui1",
  goTo: "./go-to.js?release=alpha98-ui1",
  extensionHost: "./extension-host.js?release=alpha98-ui1",
  shell: "./shell.js?release=alpha98-ui1",
  playRuntime: "./play-runtime.js?release=alpha98-ui1",
  playView: "./play-view.js?release=alpha98-ui1",
  prose: "./prose.js?release=alpha98-ui1",
  storyToolsRegistry: "./story-tools-registry.js?release=alpha98-ui1",
  storyToolsRuntime: "./story-tools-runtime.js?release=alpha98-ui1",
  storyToolsView: "./story-tools-view.js?release=alpha98-ui1",
  liveStoryTools: "./live-story-tools.js?release=alpha98-ui1",
  livedLocation: "./lived-location.js?release=alpha98-ui1",
  charterTools: "./story-tools/charters.js?release=alpha98-ui1",
  atmosphereRuntime: "./atmosphere-runtime.js?release=alpha98-ui1",
});
