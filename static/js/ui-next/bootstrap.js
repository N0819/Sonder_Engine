import { assertReleaseModules } from "./release.js?release=alpha98-ui10-0415f377b12f";
...
const SERVICE_PATHS = Object.freeze({
  api: "./api.js?release=alpha98-ui10-0415f377b12f",
  errors: "./errors.js?release=alpha98-ui10-0415f377b12f",
  store: "./store.js?release=alpha98-ui10-0415f377b12f",
  router: "./router.js?release=alpha98-ui10-0415f377b12f",
  localization: "./localization.js?release=alpha98-ui10-0415f377b12f",
  content: "./content.js?release=alpha98-ui10-0415f377b12f",
  tasks: "./tasks.js?release=alpha98-ui10-0415f377b12f",
  notices: "./notices.js?release=alpha98-ui10-0415f377b12f",
  diagnostics: "./diagnostics.js?release=alpha98-ui10-0415f377b12f",
  storage: "./storage.js?release=alpha98-ui10-0415f377b12f",
  credentials: "./credentials.js?release=alpha98-ui10-0415f377b12f",
  savePolicy: "./save-policy.js?release=alpha98-ui10-0415f377b12f",
  extensions: "./extensions.js?release=alpha98-ui10-0415f377b12f",
  extensionsV1: "./extensions-v1.js?release=alpha98-ui10-0415f377b12f",
  destinations: "./destinations.js?release=alpha98-ui10-0415f377b12f",
  settingsView: "./settings-view.js?release=alpha98-ui10-0415f377b12f",
  inspectorHost: "./inspector-host.js?release=alpha98-ui10-0415f377b12f",
  libraryRuntime: "./library-runtime.js?release=alpha98-ui10-0415f377b12f",
  libraryView: "./library-view.js?release=alpha98-ui10-0415f377b12f",
  libraryAuthoringRuntime: "./library-authoring-runtime.js?release=alpha98-ui10-0415f377b12f",
  libraryAuthoringView: "./library-authoring-view.js?release=alpha98-ui10-0415f377b12f",
  libraryStoryEditor: "./library-editors/story.js?release=alpha98-ui10-0415f377b12f",
  libraryPersonEditor: "./library-editors/character-persona.js?release=alpha98-ui10-0415f377b12f",
  libraryPersonSections: "./library-editors/person-sections.js?release=alpha98-ui10-0415f377b12f",
  navigationState: "./navigation-state.js?release=alpha98-ui10-0415f377b12f",
  shortcuts: "./shortcuts.js?release=alpha98-ui10-0415f377b12f",
  goTo: "./go-to.js?release=alpha98-ui10-0415f377b12f",
  extensionHost: "./extension-host.js?release=alpha98-ui10-0415f377b12f",
  shell: "./shell.js?release=alpha98-ui10-0415f377b12f",
  playRuntime: "./play-runtime.js?release=alpha98-ui10-0415f377b12f",
  playView: "./play-view.js?release=alpha98-ui10-0415f377b12f",
  prose: "./prose.js?release=alpha98-ui10-0415f377b12f",
  storyToolsRegistry: "./story-tools-registry.js?release=alpha98-ui10-0415f377b12f",
  storyToolsRuntime: "./story-tools-runtime.js?release=alpha98-ui10-0415f377b12f",
  storyToolsView: "./story-tools-view.js?release=alpha98-ui10-0415f377b12f",
  liveStoryTools: "./live-story-tools.js?release=alpha98-ui10-0415f377b12f",
  livedLocation: "./lived-location.js?release=alpha98-ui10-0415f377b12f",
  charterTools: "./story-tools/charters.js?release=alpha98-ui10-0415f377b12f",
  atmosphereRuntime: "./atmosphere-runtime.js?release=alpha98-ui10-0415f377b12f",
});
