import { assertReleaseModules } from "./release.js?release=alpha98-ui9-ff279a1d1d7f";
...
const SERVICE_PATHS = Object.freeze({
  api: "./api.js?release=alpha98-ui9-ff279a1d1d7f",
  errors: "./errors.js?release=alpha98-ui9-ff279a1d1d7f",
  store: "./store.js?release=alpha98-ui9-ff279a1d1d7f",
  router: "./router.js?release=alpha98-ui9-ff279a1d1d7f",
  localization: "./localization.js?release=alpha98-ui9-ff279a1d1d7f",
  content: "./content.js?release=alpha98-ui9-ff279a1d1d7f",
  tasks: "./tasks.js?release=alpha98-ui9-ff279a1d1d7f",
  notices: "./notices.js?release=alpha98-ui9-ff279a1d1d7f",
  diagnostics: "./diagnostics.js?release=alpha98-ui9-ff279a1d1d7f",
  storage: "./storage.js?release=alpha98-ui9-ff279a1d1d7f",
  credentials: "./credentials.js?release=alpha98-ui9-ff279a1d1d7f",
  savePolicy: "./save-policy.js?release=alpha98-ui9-ff279a1d1d7f",
  extensions: "./extensions.js?release=alpha98-ui9-ff279a1d1d7f",
  extensionsV1: "./extensions-v1.js?release=alpha98-ui9-ff279a1d1d7f",
  destinations: "./destinations.js?release=alpha98-ui9-ff279a1d1d7f",
  settingsView: "./settings-view.js?release=alpha98-ui9-ff279a1d1d7f",
  inspectorHost: "./inspector-host.js?release=alpha98-ui9-ff279a1d1d7f",
  libraryRuntime: "./library-runtime.js?release=alpha98-ui9-ff279a1d1d7f",
  libraryView: "./library-view.js?release=alpha98-ui9-ff279a1d1d7f",
  libraryAuthoringRuntime: "./library-authoring-runtime.js?release=alpha98-ui9-ff279a1d1d7f",
  libraryAuthoringView: "./library-authoring-view.js?release=alpha98-ui9-ff279a1d1d7f",
  libraryStoryEditor: "./library-editors/story.js?release=alpha98-ui9-ff279a1d1d7f",
  libraryPersonEditor: "./library-editors/character-persona.js?release=alpha98-ui9-ff279a1d1d7f",
  libraryPersonSections: "./library-editors/person-sections.js?release=alpha98-ui9-ff279a1d1d7f",
  navigationState: "./navigation-state.js?release=alpha98-ui9-ff279a1d1d7f",
  shortcuts: "./shortcuts.js?release=alpha98-ui9-ff279a1d1d7f",
  goTo: "./go-to.js?release=alpha98-ui9-ff279a1d1d7f",
  extensionHost: "./extension-host.js?release=alpha98-ui9-ff279a1d1d7f",
  shell: "./shell.js?release=alpha98-ui9-ff279a1d1d7f",
  playRuntime: "./play-runtime.js?release=alpha98-ui9-ff279a1d1d7f",
  playView: "./play-view.js?release=alpha98-ui9-ff279a1d1d7f",
  prose: "./prose.js?release=alpha98-ui9-ff279a1d1d7f",
  storyToolsRegistry: "./story-tools-registry.js?release=alpha98-ui9-ff279a1d1d7f",
  storyToolsRuntime: "./story-tools-runtime.js?release=alpha98-ui9-ff279a1d1d7f",
  storyToolsView: "./story-tools-view.js?release=alpha98-ui9-ff279a1d1d7f",
  liveStoryTools: "./live-story-tools.js?release=alpha98-ui9-ff279a1d1d7f",
  livedLocation: "./lived-location.js?release=alpha98-ui9-ff279a1d1d7f",
  charterTools: "./story-tools/charters.js?release=alpha98-ui9-ff279a1d1d7f",
  atmosphereRuntime: "./atmosphere-runtime.js?release=alpha98-ui9-ff279a1d1d7f",
});
