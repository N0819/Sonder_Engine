...
from world.spatial_orientation import (
    ...
    _REL_SECTORS,
    _RIGHT_SECTORS,
    DERIVED_BEARING_LIMIT,
    DERIVED_BEARING_ORDER,
...
from world.spatial_identity import (
    ...
    room_name_words, room_spellings, room_words_answer, same_subject,
    scene_names_body, scene_room_id,
)
...
from world.spatial_barriers import (
    ...
    _BARRIER_FAST_QUALIFIERS, _BARRIER_SEALED_FORM,
...
from world.spatial_containment import (
    ...
    place_enclosed_bodies, replace_engine_minted_interiors,
    scale_changed_names,
...
from world.spatial_contacts import (
    ...
    _normalize_contact_motion, _part_is_clothing,
...
from world.spatial_geometry import (
    ...
    DEFAULT_ROOM_SIZE, EXTENT_MAX_PACES, EXTENT_MIN_PACES, extent_clamp,
    normalize_extent,
    normalize_offset, size_from_extent, _sector_label, _station,
    ...
    _detail_names_subject, _moved_subject_is_body,
...
from world.spatial_sound_field import (
    ...
    _event_power, _SOUND_FIELD_CACHE, _OFF, _PARTITION_RANK, _power_of_level,
    _ROUND_RANK, _running, AMBIENT, APERTURE_PASS, CROWD_SOUND, DIAGONAL_COST,
    OCCLUDER_PASS,
