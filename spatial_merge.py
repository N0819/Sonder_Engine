...
from spatial_orientation import (normalize_bearing, normalize_scene_bearings,
                                 opposite_bearing)

from spatial_barriers import (_PASSABLE_BARRIERS, normalize_barrier,
                              normalize_scene_barriers)
from spatial_contact_migration import contacts_from_entity_state
from spatial_contacts import (apply_contact_ops,
...
from spatial_geometry import (apply_pose_diff, derive_scene_stations,
                              normalize_scene_poses, normalize_scene_stations)
from spatial_identity import (_ci_get, _entity_named, _position_of,
                              is_derived_room_name, normalize_scene_subjects)
from spatial_senses import apply_comms_ops, normalize_scene_comms
from spatial_substance import apply_substance_ops
from spatial_transit import apply_transit_dock_edges, infer_body_enclosures
