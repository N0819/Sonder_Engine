...
#
# REGENERATED ONCE, on 2026-09-16, and this is the record. Anchor placement
# stopped reserving the ring of cells against the walls
# (`spatial_fov.DEFAULT_LANE`, owner ruling: "I'm still not convinced wall
# adjacent tiles should be restricted in any way"): a fixture with a bearing
# sits ON its wall unless it authors a `lane`, and a fixture with no bearing
# may be seeded anywhere rather than only inside the ring. `cover` at a
# flush fixture now falls through to the room side, because a thing against
# a wall has no behind -- which is the answer the fiction wanted. Any OTHER
# drift in these numbers is still a failing test.
FROZEN = {
    "l": {
        "anchors": {
            "bar": [
