...
def test_shell_sources_are_explicit_release_coherent_modules():
    ...
    assert releases == {"alpha98-ui6-ff8a9b712a2d"}
...
def test_application_entry_uses_the_semantic_shell_and_no_classic_assets():
    ...
    assert '/static/css/ui/shell.css?release=alpha98-ui6-ff8a9b712a2d' in html
    assert '/static/js/ui-next/main.js?release=alpha98-ui6-ff8a9b712a2d' in html
    assert '<nav ' in html
    assert '<main ' in html
