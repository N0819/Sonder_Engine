...
def test_shell_sources_are_explicit_release_coherent_modules():
    ...
    assert releases == {"alpha98-ui9-ff279a1d1d7f"}
...
def test_application_entry_uses_the_semantic_shell_and_no_classic_assets():
    ...
    assert 'data-ui-next-version="alpha98-ui9-ff279a1d1d7f"' in html
    assert '/static/css/ui/shell.css?release=alpha98-ui9-ff279a1d1d7f' in html
    assert '/static/js/ui-next/main.js?release=alpha98-ui9-ff279a1d1d7f' in html
    assert '<nav ' in html
    assert '<main ' in html
