...
`serves` stayed generic, and `commit.py`'s goal matching could not use either.
...
The resolution is the mode set already named in `schemas.py`, now enforced:
