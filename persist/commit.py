...
from persist.commit_background import (beat_reactions, BACKGROUND_PROMOTION_DIALOGUE_THRESHOLD,
    apply_presence_departures,
    apply_presence_handovers,
    ...
    _shared_name_words, _communication_targets, _propose_promotions,
    _character_address_of,
    _at_own_station, _authored_arrival_rooms, _owed_clock_seconds,
    abandoned_debts, apply_abandoned_debts, owed_service, owed_to,
    _room_address_of, authored_mind_rooms, demand_reaches,
    address_reaches, spoken_volumes, beat_scene, _word_stems,
    _presence_surface_words, _bodies_the_description_could_be_true_of,
    _valid_pending_act, _valid_pending_reply, _background_fired_reactions,
    ...
    descriptor_bindings, _addressed_ref_strings, _player_intended_targets,
...
def _commit_all_locked(ctx, nonce):
    ...
    # open for the Writers' Room (`world.planning_needs`).
    try:
        from world.planning_needs import schedule_planning_needs
