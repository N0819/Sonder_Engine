...
#:
#: One capability is deliberately absent: coordinated frame-coherent reads
#: (`api.frame_state`/`char_state`/`player_view` resolving against one chosen
#: frame). Frame-SCOPED state exists and is declared below as `frame_state`;
#: one authoritative frame SELECTION across several reads does not, and
#: naming it here before it exists is the one thing capability discovery must
#: never do.
...
__all__ = [
    ...
    "ExtState", "ExtensionError", "HOST_CAPABILITIES",
