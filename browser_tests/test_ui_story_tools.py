    ...
    result = page.evaluate(
        """async base => {
          const registry = await import(
            `${base}/static/js/ui-next/story-tools-registry.js?release=alpha98-ui10-c14a4cf8dabd`
          );
          const router = await import(`${base}/static/js/ui-next/router.js?release=alpha98-ui10-c14a4cf8dabd`);
...
def test_story_tool_detail_replaces_list_and_uses_distinct_svg_icons(
    ...
    assert hrefs == {
        "conditions": "/static/assets/icons/sonder-icons.svg?release=alpha98-ui10-c14a4cf8dabd#icon-conditions",
        "frames": "/static/assets/icons/sonder-icons.svg?release=alpha98-ui10-c14a4cf8dabd#icon-frames",
        "multiplayer": "/static/assets/icons/sonder-icons.svg?release=alpha98-ui10-c14a4cf8dabd#icon-multiplayer",
    }
