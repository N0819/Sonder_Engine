    ...
    result = page.evaluate(
        """async base => {
          const registry = await import(
            `${base}/static/js/ui-next/story-tools-registry.js?release=alpha98-ui15-5b0f039aae29`
          );
          const router = await import(`${base}/static/js/ui-next/router.js?release=alpha98-ui15-5b0f039aae29`);
...
def test_story_tool_detail_replaces_list_and_uses_distinct_svg_icons(
    ...
    assert hrefs == {
        "conditions": "/static/assets/icons/sonder-icons.svg?release=alpha98-ui15-5b0f039aae29#icon-conditions",
        "frames": "/static/assets/icons/sonder-icons.svg?release=alpha98-ui15-5b0f039aae29#icon-frames",
        "multiplayer": "/static/assets/icons/sonder-icons.svg?release=alpha98-ui15-5b0f039aae29#icon-multiplayer",
    }
