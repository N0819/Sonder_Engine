...
def test_character_quick_start_sends_alpha98_history_contract(
    ...
    result = page.evaluate(
        """async base => {
          ...
          const runtimeModule = await import(`${base}/static/js/ui-next/library-authoring-runtime.js?release=alpha98-ui5-98f796584158`);
    ...
    result = page.evaluate(
        """async base => {
          ...
          const authoringModule = await import(
            `${base}/static/js/ui-next/library-authoring-runtime.js?release=alpha98-ui5-98f796584158`
          );
          const store = storeModule.createStore();
          let route = {
