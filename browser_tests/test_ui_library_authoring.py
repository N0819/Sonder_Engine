...
def test_character_quick_start_sends_alpha98_history_contract(
    ...
    result = page.evaluate(
        """async base => {
          ...
          const runtimeModule = await import(`${base}/static/js/ui-next/library-authoring-runtime.js?release=alpha98-ui6-ff8a9b712a2d`);
    ...
    result = page.evaluate(
        """async base => {
          ...
          const authoringModule = await import(
            `${base}/static/js/ui-next/library-authoring-runtime.js?release=alpha98-ui6-ff8a9b712a2d`
          );
          const store = storeModule.createStore();
          let route = {
