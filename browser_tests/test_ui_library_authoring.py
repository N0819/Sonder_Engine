...
def test_character_quick_start_sends_alpha98_history_contract(
    ...
    result = page.evaluate(
        """async base => {
          ...
          const runtimeModule = await import(`${base}/static/js/ui-next/library-authoring-runtime.js?release=alpha98-ui12-7eaf6b3481a3`);
    ...
    result = page.evaluate(
        """async base => {
          ...
          const authoringModule = await import(
            `${base}/static/js/ui-next/library-authoring-runtime.js?release=alpha98-ui12-7eaf6b3481a3`
          );
          const store = storeModule.createStore();
          let route = {
